    ...
    def generate(cls):
        object_info = {
            ...
            "spec": {
                ...
                "rootVolume": {"type": "SATA", "size": random.randint(40, 100)},
                "dataVolumes": [
                    {
                        "type": "SSD",
...
class FakeNodePool(test_base.Fake):
    ...
    def generate(cls):
        object_info = {
            "kind": "NodePool",
            "apiVersion": "v3",
            "metadata": {"name": "name-" + uuid.uuid4().hex},
            "spec": {
                "initialNodeCount": 0,
                "type": "vm",
                "autoscaling": {
                ...
                "nodeManagement": {"serverGroupReference": "sg-" + uuid.uuid4().hex},
                "nodeTemplate": {
                    "flavor": "s2.large.2 ",
                    "az": random.choice(["random", "eu-de-01", "eu-de-02", "eu-de-03"]),
                    "os": "EulerOS 2.5",
                    "login": {"sshKey": "key-" + uuid.uuid4().hex},
                    "rootVolume": {
                    ...
                    "taints": [
                        {
                            ...
                            "effect": random.choice(
                                ["NoSchedule", "PrefereNoSchedule", "NoExecute"]
                            ),
                        },
                        {
                            "key": "key-" + uuid.uuid4().hex,
            ...
            "status": {"currentNode": random.randint(0, 100), "phase": ""},
        }
