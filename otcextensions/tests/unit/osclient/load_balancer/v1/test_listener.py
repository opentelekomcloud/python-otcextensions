...
class TestListListener(fakes.TestLoadBalancer):
    ...
    def test_list_default(self):
        ...
        # Set the response
        self.client.listeners.side_effect = [self._objects]
    ...
    def test_list_filters(self):
        ...
        self.client.listeners.assert_called_once_with(
            protocol="TCP", protocol_port=12, name="some_name", load_balancer_id="lb"
        )
    ...
    def test_list_filters_exceptions_proto(self):
        arglist = ["--protocol", "SMTP", "--protocol_port", "12"]

        verifylist = [("protocol", "SMTP"), ("protocol_port", 12)]
...
class TestShowListener(fakes.TestLoadBalancer):
    ...
    def test_show_default(self):
        ...
        verifylist = [("listener", "lb")]
        # Verify cm is triggereg with default parameters
        parsed_args = self.check_parser(self.cmd, arglist, verifylist)

        # Set the response
        self.client.find_listener.side_effect = [self._object]
...
class TestCreateListener(fakes.TestLoadBalancer):
    ...
    def test_create_default(self):
        ...
        # Set the response
        self.client.create_listener.side_effect = [self._object]
...
class TestUpdateListener(fakes.TestLoadBalancer):
    ...
    def test_update_default(self):
        ...
        # Set the response
        self.client.update_listener.side_effect = [self._object]
...
class TestDeleteListener(fakes.TestLoadBalancer):
    ...
    def test_delete_default(self):
        ...
        self.client.delete_listener.assert_called_once_with(
            listener=self._object.id, ignore_missing=False
        )
