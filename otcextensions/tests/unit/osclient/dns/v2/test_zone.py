...
class TestListZone(fakes.TestDNS):
    ...
    def test_default_query(self):
        ...
        self.client.api_mock.assert_called_once_with(zone_type="private")
...
class TestShowZone(fakes.TestDNS):
    ...
    def test_default(self):
        ...
        self.client.api_mock.assert_called_once_with("zone", ignore_missing=False)
...
class TestCreateZone(fakes.TestDNS):
    ...
    def test_create(self):
        ...
        self.client.api_mock.assert_called_once_with(
            description="descr", email="eml", name="zn", ttl=500, zone_type="public"
        )
...
class TestSetZone(fakes.TestDNS):
    ...
    def test_update(self):
        ...
        self.client.find_zone.assert_called_once_with("zn", ignore_missing=False)

        self.client.api_mock.assert_called_once_with(
            zone=self._data, description="descr", email="eml", ttl=500
        )
...
class TestDeleteZone(fakes.TestDNS):
    ...
    def test_delete_multiple(self):
        ...
        calls = [mock.call(zone="t1"), mock.call(zone="t2")]
...
class TestAssociateRouter(fakes.TestDNS):
    ...
    def test_default(self):
        ...
        self.client.api_mock.assert_called_once_with(
            zone=self._data, router_id="rid", router_region="regio"
        )
