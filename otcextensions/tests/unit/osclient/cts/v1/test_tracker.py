...
class TestShowTracker(fakes.TestCTS):
    ...
    columns = ("bucket_name", "file_prefix_name", "id", "name", "smn", "status")
    ...
    def test_show_default(self):
        ...
        # Set the response
        self.client.get_tracker.side_effect = [self._data]

        # Trigger the action
        columns, data = self.cmd.take_action(parsed_args)

        self.client.get_tracker.assert_called_with(tracker="name_or_id")
...
class TestCreateTracker(fakes.TestCTS):
    ...
    def test_create_default(self):
        ...
        # Set the response
        self.client.create_tracker.side_effect = [self._data]
...
class TestSetTracker(fakes.TestCTS):
    ...
    def test_update_default(self):
        ...
        # Set the response
        self.client.update_tracker.side_effect = [self._data]
    ...
    def test_update_disable(self):
        arglist = ["system", "--bucket_name", "1", "--disable"]
        verifylist = [
            ("tracker", "system"),
            ("bucket_name", "1"),
            # ('enable_smn', False),
        ...
        self.client.update_tracker.assert_called_with(
            tracker="system", bucket_name="1", smn={"enable": False}, status="disabled"
        )
