...
class TestSnapshot(base.TestCase):
    ...
    def test_basic(self):
        ...
        self.assertEqual("/clusters/%(uri_cluster_id)s/index_snapshot", sot.base_path)
    ...
    def test_make_it(self):
        ...
        self.assertEqual(EXAMPLE["backupExpectedStartTime"], sot.backup_start_time)
    ...
    def test_restore(self):
        ...
        uri = utils.urljoin("clusters", cluster_id, "index_snapshot", sot.id, "restore")
