...
class TestBackup(base.TestCase):
    ...
    def test_make_it(self):
        ...
        self.assertEqual(
            EXAMPLE["replication_records"], test_backup.replication_records
        )
        ...
        self.assertEqual(
            EXAMPLE["extend_info"]["architecture"], test_backup.extend_info.architecture
        )
    ...
    def test_add_members(self):
        ...
        self.sess.post.assert_called_once_with(
            "backups/%s/members" % EXAMPLE["id"], json={"members": members}
        )
