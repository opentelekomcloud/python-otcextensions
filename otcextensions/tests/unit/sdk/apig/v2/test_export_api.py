...
EXAMPLE_IMPORT = {
    ...
    "success": [
        {"id": "api-1", "method": "GET", "path": "/success", "action": "import"}
    ],
    "failure": [
        {
            "method": "POST",
...
class TestExportApi(base.TestCase):
    ...
    def test_basic(self):
        ...
        self.assertEqual("apigw/instances/%(gateway_id)s/openapi/export", sot.base_path)
...
class TestImportApi(base.TestCase):
    ...
    def test_basic(self):
        ...
        self.assertEqual("apigw/instances/%(gateway_id)s/openapi/import", sot.base_path)
