...
class TestAclApiBinding(base.TestCase):
    ...
    def test_basic(self):
        ...
        self.assertEqual("apigw/instances/%(gateway_id)s/acl-bindings", sot.base_path)
    ...
    def test_make_it(self):
        ...
        self.assertEqual(EXAMPLE_ACL_API_BINDING["create_time"], sot.create_time)
...
class TestAclBindingFailure(base.TestCase):
    ...
    def test_make_it(self):
        ...
        self.assertEqual(EXAMPLE_ACL_BINDING_FAILURE["error_code"], sot.error_code)
        self.assertEqual(EXAMPLE_ACL_BINDING_FAILURE["error_msg"], sot.error_msg)
        self.assertEqual(EXAMPLE_ACL_BINDING_FAILURE["api_id"], sot.api_id)
        self.assertEqual(EXAMPLE_ACL_BINDING_FAILURE["api_name"], sot.api_name)
...
class TestApiForAcl(base.TestCase):
    ...
    def test_basic(self):
        ...
        self.assertEqual(
            "apigw/instances/%(gateway_id)s/acl-bindings/binded-apis", sot.base_path
        )
...
class TestUnbindApiForAcl(base.TestCase):
    ...
    def test_basic(self):
        ...
        self.assertEqual(
            "apigw/instances/%(gateway_id)s/acl-bindings/unbinded-apis", sot.base_path
        )
        self.assertTrue(sot.allow_list)
        self.assertEqual("apis", sot.resources_key)
    ...
    def test_make_it(self):
        ...
        self.assertEqual(EXAMPLE_UNBIND_API_FOR_ACL["gateway_id"], sot.gateway_id)
        ...
        self.assertEqual(EXAMPLE_UNBIND_API_FOR_ACL["group_name"], sot.group_name)
        self.assertEqual(EXAMPLE_UNBIND_API_FOR_ACL["type"], sot.type)
        self.assertEqual(EXAMPLE_UNBIND_API_FOR_ACL["remark"], sot.remark)
        self.assertEqual(EXAMPLE_UNBIND_API_FOR_ACL["run_env_name"], sot.run_env_name)
        self.assertEqual(EXAMPLE_UNBIND_API_FOR_ACL["run_env_id"], sot.run_env_id)
        self.assertEqual(EXAMPLE_UNBIND_API_FOR_ACL["publish_id"], sot.publish_id)
        ...
        self.assertEqual(EXAMPLE_UNBIND_API_FOR_ACL["auth_type"], sot.auth_type)
        self.assertEqual(EXAMPLE_UNBIND_API_FOR_ACL["req_method"], sot.req_method)
...
class TestAclForApi(base.TestCase):
    ...
    def test_basic(self):
        ...
        self.assertEqual(
            "apigw/instances/%(gateway_id)s/acl-bindings/binded-acls", sot.base_path
        )
        self.assertTrue(sot.allow_list)
