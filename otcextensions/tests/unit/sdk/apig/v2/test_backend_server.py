...
class TestBackendServer(base.TestCase):
    ...
    def test_basic(self):
        ...
        self.assertEqual(
            "apigw/instances/%(gateway_id)s/vpc-channels/%(vpc_chan_id)s/" "members",
            sot.base_path,
        )
    ...
    def test_make_it(self):
        ...
        self.assertEqual(EXAMPLE_MEMBER["member_group_name"], sot.member_group_name)
        ...
        self.assertEqual(EXAMPLE_MEMBER["member_group_id"], sot.member_group_id)
