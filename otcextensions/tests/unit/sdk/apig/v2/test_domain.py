...
class TestDomainName(base.TestCase):
    ...
    def test_basic(self):
        ...
        self.assertEqual(
            "/apigw/instances/%(gateway_id)s/" "api-groups/%(group_id)s/domains",
            sot.base_path,
        )
...
EXAMPLE_DEBUG = {"sl_domain_access_enabled": True}
...
class TestDomainDebug(base.TestCase):
    ...
    def test_make_it(self):
        ...
        self.assertEqual(
            EXAMPLE_DEBUG["sl_domain_access_enabled"], sot.sl_domain_access_enabled
        )
