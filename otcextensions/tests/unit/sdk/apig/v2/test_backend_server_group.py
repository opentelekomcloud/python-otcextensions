...
EXAMPLE_LABEL = {"label_name": "env", "label_value": "prod"}
...
class TestBackendServerGroup(base.TestCase):
    ...
    def test_make_it(self):
        ...
        self.assertEqual(EXAMPLE_GROUP["member_group_name"], sot.member_group_name)
        self.assertEqual(EXAMPLE_GROUP["member_group_remark"], sot.member_group_remark)
        self.assertEqual(EXAMPLE_GROUP["member_group_weight"], sot.member_group_weight)
        self.assertEqual(EXAMPLE_GROUP["dict_code"], sot.dict_code)
        self.assertEqual(
            EXAMPLE_GROUP["microservice_version"], sot.microservice_version
        )
        self.assertEqual(EXAMPLE_GROUP["microservice_port"], sot.microservice_port)
        self.assertEqual(EXAMPLE_GROUP["member_group_id"], sot.member_group_id)
