...
class TestSignatureBind(base.TestCase):
    ...
    def test_basic(self):
        ...
        self.assertEqual("/apigw/instances/%(gateway_id)s/sign-bindings", sot.base_path)
...
class TestNotBoundApi(base.TestCase):
    ...
    def test_basic(self):
        ...
        self.assertEqual(
            "/apigw/instances/%(gateway_id)s/sign-bindings/unbinded-apis", sot.base_path
        )
        self.assertTrue(sot.allow_list)
...
class TestBoundApi(base.TestCase):
    ...
    def test_basic(self):
        ...
        self.assertEqual(
            "/apigw/instances/%(gateway_id)s/sign-bindings/binded-apis", sot.base_path
        )
        self.assertTrue(sot.allow_list)
        self.assertEqual("bindings", sot.resources_key)
