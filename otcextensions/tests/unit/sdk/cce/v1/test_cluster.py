...
class TestCluster(base.TestCase):
    ...
    def test_list(self):
        ...
        self.sess.get.assert_called_once_with(
            "/clusters", params={}, headers=OS_HEADERS
        )
    ...
    def test_get(self):
        ...
        self.sess.get.assert_called_once_with(
            "clusters/%s" % EXAMPLE_LIST[0]["metadata"]["uuid"], headers=OS_HEADERS
        )

        self.assertDictEqual(result.to_dict(), self.sot_expected.to_dict())
    ...
    def test_update(self):
        ...
        sot._update(**{"spec": {"publicip_id": "some_ip", "description": "descr"}})
    ...
    def test_delete(self):
        ...
        self.sess.delete.assert_called_once_with(
            "clusters/%s" % sot.id, headers=OS_HEADERS
        )
