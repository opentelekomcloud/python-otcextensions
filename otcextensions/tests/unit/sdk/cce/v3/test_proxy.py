...
class TestCCECluster(TestCCEProxy):
    ...
    def test_get(self):
        self.verify_get(self.proxy.get_cluster, _cluster.Cluster, expected_kwargs={})
    ...
    def test_delete(self):
        self.verify_delete(
            self.proxy.delete_cluster, _cluster.Cluster, True, expected_kwargs={}
        )
    ...
    def test_get_certs(self):
        ...
        self._verify(
            ...
            expected_kwargs={"cluster_id": cluster.id, "requires_id": False},
        )
...
class TestCCEClusterNode(TestCCEProxy):
    ...
    def test_list(self):
        self.verify_list(
            self.proxy.cluster_nodes,
            _cluster_node.ClusterNode,
            method_args=[_cluster.Cluster(id="cluster_id")],
            method_kwargs={},
            expected_kwargs={"paginated": False, "cluster_id": "cluster_id"},
            expected_args=[],
        )
    ...
    def test_delete_node(self):
        ...
        self._verify(
            ...
            expected_kwargs={"cluster_id": cluster.id, "ignore_missing": True},
        )
...
class TestCCEJob(TestCCEProxy):
    def test_get(self):
        self.verify_get(self.proxy.get_job, _job.Job, expected_kwargs={})
    ...
    def test_wait_for_job(self):
        ...
        self.verify_wait_for_status(
            ...
            expected_args=[self.proxy, "some_fake", "success", ["FAILED"], 5, 3600],
            expected_kwargs={"attribute": "status.status"},
        )
...
class TestExtractName(TestCCEProxy):
    ...
    def test_extract_name(self):
        ...
        self.assertEqual(
            ["clusters"],
            self.proxy._extract_name("/api/v3/projects/123/clusters", project_id="123"),
        )
        self.assertEqual(
            ["cluster"],
        ...
        self.assertEqual(
            ["cluster", "clustercert"],
            self.proxy._extract_name(
                "/api/v3/projects/123/clusters/c1/clustercert", project_id="123"
            ),
        )
        self.assertEqual(
            ["cluster", "nodes"],
