...
class TestDehProxy(test_proxy_base.TestProxyBase):
    ...
    def test_hosts(self):
        self.verify_list(self.proxy.hosts, _host.Host, expected_kwargs={})
    ...
    def test_create_host(self):
        self.verify_create(
            ...
            expected_kwargs={"prepend_key": False, "x": 1, "y": "2"},
        )
    ...
    def test_servers(self):
        self.verify_list(
            ...
            method_kwargs={},
            expected_kwargs={"dedicated_host_id": "host_id"},
            expected_args=[],
        )

    def test_host_types(self):
        self.verify_list(
            self.proxy.host_types,
            _host_type.HostType,
            method_args=["az"],
            method_kwargs={},
            expected_kwargs={"paginated": False, "availability_zone": "az"},
            expected_args=[],
        )
