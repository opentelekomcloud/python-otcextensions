...
class TestHost(base.TestCase):
    ...
    def test_fetch_tags(self):
        ...
        tags = [{"key": "color", "value": "blue"}, {"key": "color", "value": "green"}]

        mock_response = mock.Mock()
        mock_response.status_code = 200
        mock_response.links = {}
        mock_response.json.return_value = {"tags": tags}
    ...
    def test_add_tags(self):
        ...
        sess.post.assert_called_once_with(url, json={"action": "create", "tags": tags})
    ...
    def test_remove_tags(self):
        ...
        self.assertEqual(res, result)
        url = "dedicated-host-tags/" + res.id + "/tags/action"
        sess.post.assert_called_once_with(url, json={"action": "delete", "tags": tags})
