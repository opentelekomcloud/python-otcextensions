...
EXAMPLE = {
    "networks": [{"id": " a8327883-6b07-4497-9c61-68d03ee193a "}],
    "detail": None,
    ...
    "security_groups": [{"id": "8a4b1d5b-0054-419f-84b1-5c8a59ebc829"}],
...
class TestGroup(base.TestCase):
    ...
    def test_make_it_extend(self):
        ...
        self.assertEqual(EXAMPLE_EXTEND["lbaas_listeners"], sot.lbaas_listeners)
        self.assertEqual(
        ...
        self.assertEqual(
            EXAMPLE_EXTEND["multi_az_priority_policy"], sot.multi_az_priority_policy
        )
