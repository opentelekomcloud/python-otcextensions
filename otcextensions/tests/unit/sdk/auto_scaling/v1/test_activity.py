...
class TestActivity(base.TestCase):
    ...
    def test_basic(self):
        ...
        self.assertEqual("/scaling_activity_log/%(scaling_group_id)s", sot.base_path)
    ...
    def test_make_it(self):
        ...
        self.assertEqual(obj["instance_added_list"], sot.instance_added_list)
        self.assertEqual(obj["instance_removed_list"], sot.instance_removed_list)
        self.assertEqual(obj["instance_deleted_list"], sot.instance_deleted_list)
