...
EXAMPLE = {
    ...
    "drill_servers": [
        {"protected_instance": uuid.uuid4(), "drill_server_id": uuid.uuid4()}
    ],
}
...
class TestDRDrill(base.TestCase):
    ...
    def test_basic(self):
        ...
        self.assertEqual("/disaster-recovery-drills", sot.base_path)
    ...
    def test_make_it(self):
        ...
        self.assertEqual(EXAMPLE["id"], test_dr_drill.id)
        self.assertEqual(EXAMPLE["name"], test_dr_drill.name)
        self.assertEqual(EXAMPLE["status"], test_dr_drill.status)
        self.assertEqual(EXAMPLE["server_group_id"], test_dr_drill.server_group_id)
        self.assertEqual(EXAMPLE["drill_vpc_id"], test_dr_drill.drill_vpc_id)
        self.assertEqual(EXAMPLE["created_at"], test_dr_drill.created_at)
        self.assertEqual(EXAMPLE["updated_at"], test_dr_drill.updated_at)
        self.assertEqual(
