...
class TestSDRSProtectionGroup(TestSDRSProxy):
    ...
    def test_protection_group_create(self):
        self.verify_create(
            self.proxy.create_protection_group,
    ...
    def test_protection_groups(self):
        self.verify_list(
            self.proxy.protection_groups, _protection_group.ProtectionGroup
        )

    def test_protection_group_get(self):
        self.verify_get(
            self.proxy.get_protection_group, _protection_group.ProtectionGroup
        )

    def test_protection_group_delete(self):
        self.verify_delete(
            self.proxy.delete_protection_group, _protection_group.ProtectionGroup, True
        )

    def test_protection_group_find(self):
        self.verify_find(
            self.proxy.find_protection_group, _protection_group.ProtectionGroup
        )
    ...
    def test_enable_protection(self):
        ...
        self._verify(
            ...
            expected_kwargs={"protection_group": group.id},
        )
...
class TestSDRSProtedInstance(TestSDRSProxy):
    ...
    def test_protected_instance_create(self):
        self.verify_create(
            self.proxy.create_protected_instance,
    ...
    def test_protected_instance(self):
        self.verify_list(
            self.proxy.protected_instances, _protected_instance.ProtectedInstance
        )

    def test_protected_instance_get(self):
        self.verify_get(
            self.proxy.get_protected_instance, _protected_instance.ProtectedInstance
        )
    ...
    def test_protected_instance_find(self):
        self.verify_find(
            self.proxy.find_protected_instance, _protected_instance.ProtectedInstance
        )
...
class TestSDRSReplicationPair(TestSDRSProxy):
    ...
    def test_replication_pair_create(self):
        self.verify_create(
            self.proxy.create_replication_pair,
    ...
    def test_replication_pair(self):
        self.verify_list(
            self.proxy.replication_pairs, _replication_pair.ReplicationPair
        )

    def test_replication_pair_get(self):
        self.verify_get(
            self.proxy.get_replication_pair, _replication_pair.ReplicationPair
        )

    def test_replication_pair_find(self):
        self.verify_find(
            self.proxy.find_replication_pair, _replication_pair.ReplicationPair
        )
    ...
    def test_replication_pair_expand(self):
        ...
        self._verify(
            ...
            expected_args=[self.proxy],
            expected_kwargs={"replication": replication.id, "new_size": new_size},
        )
...
class TestSDRSDRDrill(TestSDRSProxy):
    ...
    def test_dr_drill_delete(self):
        self.verify_delete(self.proxy.delete_dr_drill, _dr_drill.DRDrill)

    def test_dr_drill_list(self):
        self.verify_list(self.proxy.dr_drills, _dr_drill.DRDrill)

    def test_dr_drill_get(self):
        self.verify_get(self.proxy.get_dr_drill, _dr_drill.DRDrill)

    def test_dr_drill_find(self):
        self.verify_find(self.proxy.find_dr_drill, _dr_drill.DRDrill)
...
class TestSDRSTaskCenter(TestSDRSProxy):
    ...
    def test_failed_tasks(self):
        self.verify_list(self.proxy.failed_tasks, _task_center.FailedTask)

    def test_failed_task_delete(self):
        self.verify_delete(self.proxy.delete_failed_task, _task_center.FailedTask)
