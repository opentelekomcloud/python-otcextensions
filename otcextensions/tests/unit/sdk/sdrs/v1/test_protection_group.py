...
class TestProtectionGroup(base.TestCase):
    ...
    def test_make_it(self):
        ...
        self.assertEqual(EXAMPLE["description"], test_protection_group.description)
        self.assertEqual(
        ...
        self.assertEqual(EXAMPLE["domain_name"], test_protection_group.domain_name)
        self.assertEqual(EXAMPLE["status"], test_protection_group.status)
        self.assertEqual(
            EXAMPLE["protected_status"], test_protection_group.protected_status
        )
        self.assertEqual(
            EXAMPLE["replication_status"], test_protection_group.replication_status
        )
        self.assertEqual(EXAMPLE["health_status"], test_protection_group.health_status)
        self.assertEqual(EXAMPLE["progress"], test_protection_group.progress)
        self.assertEqual(
            EXAMPLE["priority_station"], test_protection_group.priority_station
        )
        self.assertEqual(
        ...
        self.assertEqual(
            EXAMPLE["replication_num"], test_protection_group.replication_num
        )
        self.assertEqual(
            EXAMPLE["disaster_recovery_drill_num"],
            test_protection_group.disaster_recovery_drill_num,
        )
        self.assertEqual(EXAMPLE["source_vpc_id"], test_protection_group.source_vpc_id)
        self.assertEqual(EXAMPLE["target_vpc_id"], test_protection_group.target_vpc_id)
        self.assertEqual(EXAMPLE["test_vpc_id"], test_protection_group.test_vpc_id)
        self.assertEqual(EXAMPLE["dr_type"], test_protection_group.dr_type)
        self.assertEqual(EXAMPLE["created_at"], test_protection_group.created_at)
        self.assertEqual(EXAMPLE["updated_at"], test_protection_group.updated_at)
        self.assertEqual(
            EXAMPLE["protection_type"], test_protection_group.protection_type
        )
        self.assertEqual(
