...
class TestInstance(base.TestCase):
    ...
    def test_fetch_restore_times(self):
        sot = instance.Instance(**EXAMPLE)
        restore_times = [{"start_time": "some_start_time", "end_time": "some_end_time"}]
        response = mock.Mock()
        response.status_code = 200
    ...
    def test_tag_action(self):
        ...
        self.sess.post.assert_called_with("instances/IDENTIFIER/tags/action", json=tags)
    ...
    def test_add_tag(self):
        ...
        sot._tag_action.assert_called_with(
            ...
            {
                "action": "create",
                "tags": [{"key": test_tag_name, "value": test_tag_value}],
            },
        )
    ...
    def test_action(self):
        ...
        self.sess.post.assert_called_with("instances/IDENTIFIER/action", json=action)
    ...
    def test_enlarge_volume(self):
        ...
        sot._action.assert_called_with(self.sess, {"enlarge_volume": {"size": size}})
