...
class TestFlavor(TestRdsProxy):
    def test_flavors(self):
        self.verify_list(
            self.proxy.flavors,
            flavor.Flavor,
            method_kwargs={"datastore_name": "MySQL", "version_name": "5.7"},
            expected_kwargs={"datastore_name": "MySQL", "version_name": "5.7"},
        )
...
class TestDatastore(TestRdsProxy):
    def test_datastores(self):
        self.verify_list(
            ...
            datastore.Datastore,
            method_args=["ss"],
            expected_kwargs={"database_name": "ss"},
            expected_args=[],
        )
...
class TestConfiguration(TestRdsProxy):
    def test_configurations(self):
        self.verify_list(
            self.proxy.configurations,
            configuration.Configuration,
            expected_kwargs={"paginated": False},
        )

    def test_get_configuration(self):
        self.verify_get(self.proxy.get_configuration, configuration.Configuration)
    ...
    def test_delete_configuration(self):
        self.verify_delete(
            self.proxy.delete_configuration, configuration.Configuration, False
        )

    def test_delete_configuration_ignore(self):
        self.verify_delete(
            self.proxy.delete_configuration, configuration.Configuration, True
        )

    def test_update_configuration(self):
        self.verify_update(self.proxy.update_configuration, configuration.Configuration)
...
class TestBackup(TestRdsProxy):
    ...
    def test_create_backup(self):
        self.verify_create(
            ...
            expected_kwargs={"x": 1, "y": 2, "z": 3, "instance_id": "inst"},
            expected_args=[],
        )
    ...
    def test_find_backup(self):
        self.verify_find(
            ...
            backup.Backup,
            method_args=["name"],
            expected_kwargs={"ignore_missing": True, "instance_id": "name"},
    ...
    def test_wait_for_backup(self):
        ...
        self.verify_wait_for_status(
            ...
            method_args=[value],
            expected_args=[self.proxy, value, "COMPLETED", ["FAILED"], 2, 300],
        )
...
class TestInstance(TestRdsProxy):
    ...
    def test_delete_instance(self):
        self.verify_delete(self.proxy.delete_instance, instance.Instance, False)
    ...
    def test_restore(self):
        self._verify(
            ...
            method_args=["inst"],
            method_kwargs={"backup": backup.Backup(id="bck"), "restore_time": "rt"},
    ...
    def test_update_instance_backup_policy(self):
        self._verify(
            ...
            method_args=["val"],
            method_kwargs={"keep_days": 1, "start_time": "2", "period": "3"},
            expected_kwargs={"keep_days": 1, "start_time": "2", "period": "3"},
            expected_args=[self.proxy],
        )
    ...
    def test_update_flavor(self):
        self._verify(
            ...
            method_args=["val"],
            method_kwargs={"spec_code": "test.spec.code"},
    ...
    def test_get_instance_logs(self):
        self._verify(
            ...
            expected_args=[
                self.proxy,
                "errorlog",
                "2020-01-01T12:34:56+0000",
                "2020-01-02T12:34:56+0000",
                10,
                20,
                "ERROR",
            ],
    ...
    def test_add_tag(self):
        self._verify(
            ...
            self.proxy.add_tag,
            method_args=["val"],
            method_kwargs={"key": "tagkey", "value": "tagval"},
