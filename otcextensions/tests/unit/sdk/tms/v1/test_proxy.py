...
class TestTmsPredefinedTag(TestTmsProxy):
    ...
    def test_predefined_tag_create(self):
        self._verify(
            ...
            method_kwargs={"key": "key", "value": "value"},
            expected_kwargs={"key": "key", "value": "value"},
            expected_args=[
                self.proxy,
            ],
        )
    ...
    def test_predefined_tag_update(self):
        self.verify_update(
            self.proxy.update_predefined_tag,
            predefined_tag.PredefinedTag,
            method_args=[],
            method_kwargs={
                "new_tag": {"key": "key", "value": "value"},
                "old_tag": {"key": "key", "value": "new_value"},
            },
            expected_kwargs={
                "new_tag": {"key": "key", "value": "value"},
                "old_tag": {"key": "key", "value": "new_value"},
...
class TestTmsResourceTag(TestTmsProxy):
    ...
    def test_resource_tag_create(self):
        self.verify_create(
            self.proxy.create_resource_tag,
            resource_tag.ResourceTag,
            expected_args=[],
            method_kwargs={
                "project_id": "id",
                "resources": [{"resource_id": "id", "resource_type": "vpc"}],
    ...
    def test_resource_tag_delete(self):
        self.verify_delete(
            self.proxy.delete_resource_tag,
            resource_tag.ResourceTag,
            method_args=[],
            method_kwargs={
                "project_id": "id",
