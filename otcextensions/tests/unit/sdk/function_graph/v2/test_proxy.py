...
class TestFgDependencies(TestFgProxy):
    ...
    def test_create_dependency_version(self):
        self.verify_create(self.proxy.create_dependency_version, _d.Dependency)

    def test_delete_dependency_version(self):
        dep = _d.Dependency(version=1, dep_id="edbd67fa-f107-40b3-af75-a85f0577ad61")
...
class TestFgEvents(TestFgProxy):
    def test_events(self):
        ...
        self.verify_list(
            ...
            expected_args=[],
            expected_kwargs={"function_urn": func_urn.rpartition(":")[0]},
        )
    ...
    def test_create_event(self):
        ...
        self.verify_create(
            ...
            _event.Event,
            method_kwargs={"function": func, "name": "test_event"},
            expected_kwargs={
...
class TestFgAlias(TestFgProxy):
    ...
    def test_update_event(self):
        ...
        self._verify(
            "otcextensions.sdk.function_graph.v2.alias." "Alias._update_alias",
...
class TestFgMetric(TestFgProxy):
    ...
    def test_function_metrics(self):
        ...
        self.verify_list(
            ...
            _metric.Metric,
            method_args=[func, "1596686400000,1596686400000"],
            expected_args=[],
        )
...
class TestFgImportExport(TestFgProxy):
    def test_import_function(self):
        ...
        self.verify_create(
            self.proxy.import_function, _import.Import, method_kwargs={**attrs}
        )

    def test_export(self):
        function = _function.Function(id="test_function")
        self._verify(
            "otcextensions.sdk.function_graph.v2.export_function." "Export._export",
...
class TestFgTrigger(TestFgProxy):
    ...
    def test_triggers(self):
        ...
        self.verify_list(
            ...
            expected_kwargs={"function_urn": function.func_urn.rpartition(":")[0]},
            expected_args=[],
        )
    ...
    def test_delete_trigger(self):
        ...
        self._verify(
            "otcextensions.sdk.function_graph.v2.trigger." "Trigger._delete_trigger",
    ...
    def test_delete_triggers(self):
        ...
        self._verify(
            "otcextensions.sdk.function_graph.v2.trigger." "Trigger._delete_triggers",
...
class TestFgAsyncNotifications(TestFgProxy):
    ...
    def test_all_versions_async_notifications(self):
        ...
        self.verify_list(
            ...
            _async.Notification,
            method_kwargs={"function": function.func_urn},
            expected_kwargs={"function_urn": function.func_urn},
            expected_args=[],
        )
    ...
    def test_stop_async_invocation_request(self):
        ...
        self._verify(
            "otcextensions.sdk.function_graph.v2.async_notification." "Requests._stop",
