...
class TestDCSProxy(test_proxy_base.TestProxyBase):
    ...
    def test_update_instance(self):
        ...
        self.proxy._get_resource.assert_called_with(_instance.Instance, "VALUE", a="b")
    ...
    def test_extend_instance(self):
        ...
        self.proxy._get_resource.assert_called_with(_instance.Instance, self.sot)
    ...
    def test_change_pwd(self):
        ...
        self.sot.change_pwd.assert_called_with(
            self.proxy, current_password="curr", new_password="new"
        )
        self.proxy._get.assert_not_called()

    def test_statistics(self):
        self.verify_list(
            self.proxy.statistics, _stat.Statistic, expected_kwargs={"paginated": False}
        )
    ...
    def test_backups(self):
        ...
        self.proxy._list.assert_called_with(
            _backup.Backup, paginated=False, instance_id="1"
        )
    ...
    def test_backups_query(self):
        ...
        self.proxy.backups("inst", start="1", end="2", start_time="3", end_time="4")
        self.proxy._list.assert_called_with(
            _backup.Backup,
            paginated=False,
            instance_id="1",
    ...
    def test_create_backup(self):
        ...
        self.proxy._create.assert_called_with(
            _backup.Backup, instance_id="1", remark="rem"
        )
    ...
    def test_delete_backup(self):
        ...
        self._verify(
            ...
            expected_kwargs={"instance_id": instance.id, "ignore_missing": True},
        )
    ...
    def test_restores_query(self):
        ...
        self.proxy.restore_records(
            instance="inst", start="1", end="2", start_time="3", end_time="4"
        )
        self.proxy._list.assert_called_with(
    ...
    def test_restore_backup(self):
        ...
        self.proxy.restore_instance(instance="1", backup_id="bck", remark="rem")
        self.proxy._create.assert_called_with(
            _restore_record.RestoreRecord,
            instance_id="1",
            backup_id="bck",
    ...
    def test_configs(self):
        ...
        self.proxy._list.assert_called_with(
            _config.Config, paginated=False, instance_id="1"
        )
    ...
    def test_maintenance_time_windows(self, epo_mock):
        self.verify_list(
            self.proxy.maintenance_time_windows, _mtw.MaintenanceTimeWindow
        )
    ...
    def test_service_specification(self, epo_mock):
        self.verify_list(
            self.proxy.service_specifications, _service_spec.ServiceSpecification
        )
        epo_mock.assert_called_with()
    ...
    def test_availability_zones(self, epo_mock):
        self.verify_list(self.proxy.availability_zones, _az.AvailabilityZone)
        epo_mock.assert_called_with()
