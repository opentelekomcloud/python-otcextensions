...
class TestGroup(base.TestCase):
    ...
    def test_make_it(self):
        ...
        self.assertEqual(self.example["produced_messages"], sot.produced_messages)
        self.assertEqual(self.example["consumed_messages"], sot.consumed_messages)
        self.assertEqual(self.example["available_messages"], sot.available_messages)
    ...
    def test_create(self):
        ...
        self.sess.post.assert_called_with(
            "queues/qid/groups", json={"groups": [{"name": "grp"}]}
        )
