...
class TestPrivateNatGateway(base.TestCase):
    ...
    def test_make_it(self):
        ...
        self.assertEqual(
            DOWNLINK_VPC["virsubnet_id"], sot.downlink_vpcs[0].virsubnet_id
        )
        self.assertEqual(
            DOWNLINK_VPC["ngport_ip_address"], sot.downlink_vpcs[0].ngport_ip_address
        )
        ...
        self.assertEqual(
            EXAMPLE["transit_ip_pool_size_max"], sot.transit_ip_pool_size_max
        )
