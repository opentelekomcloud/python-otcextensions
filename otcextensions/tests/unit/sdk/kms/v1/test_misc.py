...
class TestRandom(base.TestCase):
    ...
    def test_basic(self):
        ...
        self.assertEqual("/kms/gen-random", sot.create_path)
    ...
    def test_create(self):
        ...
        mock_response.json.return_value = {"random_data": EXAMPLE["random_data"]}
        ...
        self.assertEqual(EXAMPLE["random_data_length"], result.random_data_length)
...
class TestInstanceNum(base.TestCase):
    ...
    def test_get(self):
        ...
        mock_response.status_code = 200
        mock_response.headers = {}
        mock_response.json.return_value = {"instance_num": 5}
        ...
        self.sess.get.assert_called_once_with(
            "kms/user-instances", microversion=None, params={}, skip_cache=False
        )
...
class TestQuota(base.TestCase):
    ...
    def test_list(self):
        ...
        mock_response.json.return_value = {
            "quotas": {
                "resources": [
                    {"type": "CMK", "used": 15, "quota": 20},
                    {"type": "grant_per_CMK", "used": 15, "quota": 100},
                ]
            }
        }
        ...
        self.sess.get.assert_called_once_with("kms/user-quotas")
