...
class TestKey(base.TestCase):
    ...
    def test_make_it(self):
        ...
        self.assertEqual(
            EXAMPLE["scheduled_deletion_date"], sot.scheduled_deletion_date
        )
    ...
    def test_list(self):
        ...
        result = list(
            self.sot.list(
                self.sess, limit=1, marker="0", key_state="state", sequence="seq"
            )
        )
    ...
    def test_create(self):
        ...
        mock_response.json.return_value = {
            "key_info": {"key_id": EXAMPLE["key_id"], "domain_id": EXAMPLE["domain_id"]}
        }
    ...
    def test_enable(self):
        ...
        self.sess.post.assert_called_once_with(
            "kms/enable-key", json={"key_id": EXAMPLE["key_id"]}
        )
    ...
    def test_disable(self):
        ...
        self.sess.post.assert_called_once_with(
            "kms/disable-key", json={"key_id": EXAMPLE["key_id"]}
        )
    ...
    def test_cancel_deletion(self):
        ...
        self.sess.post.assert_called_once_with(
            "kms/cancel-key-deletion", json={"key_id": EXAMPLE["key_id"]}
        )
