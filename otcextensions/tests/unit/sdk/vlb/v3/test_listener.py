...
EXAMPLE = {
    ...
    "ipgroup": {"ipgroup_id": "ipgroup-id", "enable_ipgroup": True, "type": "type"},
    "name": "name",
    "keepalive_timeout": 5,
    "member_timeout": 5,
    "protocol": "protocol",
...
class TestListener(base.TestCase):
    ...
    def test_make_it(self):
        ...
        self.assertEqual(
            EXAMPLE["client_ca_tls_container_ref"], sot.client_ca_tls_container_ref
        )
        ...
        self.assertEqual(EXAMPLE["enable_member_retry"], sot.enable_member_retry)
        self.assertEqual(EXAMPLE["enhance_l7policy_enable"], sot.enhance_l7policy)
        ...
        self.assertEqual(
            EXAMPLE["transparent_client_ip_enable"], sot.transparent_client_ip_enable
        )
