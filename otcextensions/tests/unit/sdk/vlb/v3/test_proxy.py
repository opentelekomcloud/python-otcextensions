...
class TestVlbLoadBalancer(TestVlbProxy):
    ...
    def test_load_balancer_get(self):
        self.verify_get(self.proxy.get_load_balancer, load_balancer.LoadBalancer)
    ...
    def test_load_balancer_find(self):
        self.verify_find(self.proxy.find_load_balancer, load_balancer.LoadBalancer)

    def test_load_balancer_update(self):
        self.verify_update(self.proxy.update_load_balancer, load_balancer.LoadBalancer)
...
class TestVlbHealthMonitor(TestVlbProxy):
    ...
    def test_health_monitor_delete(self):
        self.verify_delete(
            self.proxy.delete_health_monitor, health_monitor.HealthMonitor, True
        )

    def test_health_monitor_get(self):
        self.verify_get(self.proxy.get_health_monitor, health_monitor.HealthMonitor)

    def test_health_monitors(self):
        self.verify_list(self.proxy.health_monitors, health_monitor.HealthMonitor)

    def test_health_monitor_find(self):
        self.verify_find(self.proxy.find_health_monitor, health_monitor.HealthMonitor)
...
class TestVlbL7Policy(TestVlbProxy):
    ...
    def test_l7_policy_delete(self):
        self.verify_delete(self.proxy.delete_l7_policy, l7_policy.L7Policy, True)
...
class TestVlbL7Rule(TestVlbProxy):
    ...
    def test_l7_rule_delete(self):
        self.verify_delete(
            ...
            l7_rule.L7Rule,
            True,
            method_kwargs={"l7_policy": "l7_policy"},
            expected_kwargs={
                "l7policy_id": "l7_policy",
            },
        )
