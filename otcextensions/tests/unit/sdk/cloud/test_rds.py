    ...
    def test_create_rds_instance(self):
        self.register_uris(
            [
                ...
                dict(
                    method="POST",
                    uri=self.get_rds_url(resource="instances"),
                    status_code=200,
                    json={"instance": {"id": 123987}, "job_id": "15"},
                ),
                dict(
                    method="GET",
                    uri=self.get_rds_url(resource="jobs", qs_elements=["id=15"]),
                    status_code=200,
                ...
                dict(
                    method="GET",
                    uri=self.get_rds_url(
                        resource="instances", qs_elements=["id=123987"]
                    ),
                    status_code=200,
        ...
        self.register_uris(
            [
                dict(
                    method="GET",
                    uri=self.get_rds_url(
                        resource="instances", qs_elements=["id=fake_name"]
                    ),
                    status_code=200,
                    json={
                        "instances": [
                ...
                dict(
                    ...
                    uri=self.get_rds_url(resource="instances"),
                    status_code=200,
                    json={"instance": {"id": 1239876}, "job_id": "15"},
                ),
                dict(
                    method="GET",
                    uri=self.get_rds_url(resource="jobs", qs_elements=["id=15"]),
                ...
                dict(
                    method="GET",
                    uri=self.get_rds_url(
                        resource="instances", qs_elements=["id=1239876"]
                    ),
                    status_code=200,
                    json={"instances": [{"id": 1239876, "name": "copy_name"}]},
                ),
            ]
        )
        ...
        self.register_uris(
            [
                dict(
                    method="GET",
                    uri=self.get_rds_url(
                        resource="instances", qs_elements=["id=source_instance"]
                    ),
                    status_code=200,
                    json={
                        "instances": [
                ...
                dict(
                    ...
                    status_code=200,
                    json={"instances": [{"id": 1239876, "name": "inst_name"}]},
                ),
            ]
        )
        ...
        self.register_uris(
            [
                ...
                dict(
                    ...
                    uri=self.get_rds_url(
                        resource="backups",
                        qs_elements=["instance_id=123987", "backup_id=source_backup"],
                    ),
                    status_code=200,
                    json={
                        "backups": [
