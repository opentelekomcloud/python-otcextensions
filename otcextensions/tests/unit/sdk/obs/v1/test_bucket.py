...
from otcextensions.sdk.obs.v1 import bucket
...
class TestBucket(base.TestCase):
    ...
    def test_make_it(self):
        sot = bucket.Bucket(**EXAMPLE)
        self.assertEqual(IDENTIFIER, sot.id)
        # self.assertEqual(EXAMPLE['links'], sot.links)
        self.assertEqual(EXAMPLE['name'], sot.name)
        self.assertEqual(EXAMPLE['creationdate'], sot.creationdate)
