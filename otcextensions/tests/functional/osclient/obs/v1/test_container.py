...
class ObsContainerTests(base.TestCase):
    ...
    def tearDown(self):
        try:
            self.openstack(DELETE_COMMAND % {"name": self.NAME})
        finally:
    ...
    def test_container_list(self):
        json_output = json.loads(self.openstack("obs container list -f json "))
        self.assertIn(self.NAME, [cont["name"] for cont in json_output])
