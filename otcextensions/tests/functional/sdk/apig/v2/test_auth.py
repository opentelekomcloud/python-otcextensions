...
import otcextensions.sdk.apig.v2.api_auth as _auth
...
class TestAuth(TestApiG):
    ...
    def test_list_apps_bound_to_api(self):
        found = self.client.list_apps_bound_to_api(gateway="560de602c9f74969a05ff01d401a53ed")
    ...
    def test_list_api_bound_to_app(self):
        ...
        found = self.client.list_api_bound_to_app(gateway="560de602c9f74969a05ff01d401a53ed", **attrs)
        self.assertIsNotNone(list(found))

    def test_list_api_not_bound_to_app(self):
        # changed resources_key, что делать?
        # envs = list(self.client.environments(gateway="560de602c9f74969a05ff01d401a53ed"))
        attrs = {
            'app_id': '74593f5c94f64a139db38b61a7705df3',
            'env_id': 'DEFAULT_ENVIRONMENT_RELEASE_ID'
        }
        found = self.client.list_api_not_bound_to_app(gateway="560de602c9f74969a05ff01d401a53ed", **attrs)
        self.assertIsNotNone(list(found))
