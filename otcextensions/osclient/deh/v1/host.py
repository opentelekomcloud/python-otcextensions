...
class ListHost(command.Lister):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument("--id", metavar="<id>", help=_("Host id."))
        parser.add_argument("--name", metavar="<name>", help=_("Host name."))
        parser.add_argument("--host_type", metavar="<host_type>", help=_("Host type."))
        parser.add_argument(
            "--host_type_name", metavar="<host_type_name>", help=_("Host type name.")
        )
        parser.add_argument("--flavor", metavar="<flavor>", help=_("Flavor ID."))
        parser.add_argument(
            "--status",
        ...
        parser.add_argument(
            "--tenant", metavar="<tenant>", help=_('Tenant ID or "all".')
        )
        parser.add_argument(
            "--availability_zone",
        ...
        parser.add_argument(
            ...
            help=_(
                "Filters the response by a date and time stamp when the "
...
class ShowHost(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument("host", metavar="<host>", help=_("UUID of the host."))
...
class DeleteHost(command.Command):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "host", metavar="<host>", nargs="+", help=_("UUID or name of the host.")
        )
...
class CreateHost(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "--name", metavar="<name>", required=True, help=_("DNS Name for the host.")
        )
        parser.add_argument(
            "--auto_placement",
            action="store_const",
        ...
        parser.add_argument("--host_type", metavar="<type>", help=_("DeH type."))
        parser.add_argument(
            "--quantity",
            metavar="[0..]",
            type=int,
...
class SetHost(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "host", metavar="<host>", help=_("UUID or name of the host.")
        )
        parser.add_argument(
            "--name", metavar="<name>", help=_("DNS Name for the host.")
        )
        parser.add_argument(
            "--auto_placement", action="store_const", const="on", dest="auto_placement"
        )
        parser.add_argument(
            "--no-auto_placement",
            action="store_const",
        ...
        parser.add_argument(
            ...
            metavar="<key=value>",
            action="append",
            help=_("Tag to add for this host " "(repeat option to set multiple tags)"),
        )
    ...
    def take_action(self, parsed_args):
        ...
        if host:
            if attrs:
                obj = client.update_host(host=host, **attrs)
...
class UnsetHost(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            action="append",
            help=_(
                "Tag key to remove from this host "
    ...
    def take_action(self, parsed_args):
        ...
        if host:
                ...
                for tag in parsed_args.tag:
                    ...
                    if existing_tag:
                        ...
                        if len(tag_pair) == 2:
                            ...
                            xtag = {"key": k, "value": tag_pair[1]}
                        else:
                            # Existing tag value will be used
                            xtag = {"key": k, "value": existing_tag["value"]}
            ...
            data = utils.get_item_properties(host, columns, formatters=_formatters)
...
class ListServer(command.Lister):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument("host", metavar="<host>", help=_("UUID of the DeH host."))
...
class ListHostType(command.Lister):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument("az", metavar="<az>", help=_("Availability zone."))
