...
class ListVirtualGateways(command.Lister):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "--id", metavar="<id>", help=_("Specifies the Virtual Gateway ID.")
        )
        parser.add_argument(
            "--name", metavar="<name>", help=_("Specifies the Virtual Gateway name.")
        )
        parser.add_argument(
            "--vpc_id",
            metavar="<vpc_id>",
        ...
        parser.add_argument(
            ...
            help=_(
                "Specifies the ID of the local endpoint group that "
        ...
        parser.add_argument(
            "--description",
            metavar="<description>",
            help=_("Provides supplementary information about the " "Virtual Gateway."),
        )
        parser.add_argument(
            "--device_id",
            metavar="<device_id>",
            help=_(
                "Specifies the ID of the physical device used by the "
                "Virtual Gateway."
            ),
        )
        parser.add_argument(
            ...
            help=_(
                "Specifies the ID of the redundant physical device used "
        ...
        parser.add_argument(
            ...
            metavar="<type>",
            help=_(
                "Specifies the Virtual Gateway type. The value can be "
        ...
        parser.add_argument(
            ...
            type=bool,
            help=_(
                "Specifies the administrative status of the Virtual "
...
class CreateVirtualGateway(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            metavar="<local_ep_group_id>",
            help=_(
                "Specifies the ID of the local endpoint group that records "
        ...
        parser.add_argument(
            ...
            metavar="<type>",
            help=_(
                "Specifies the Virtual Gateway type. "
        ...
        parser.add_argument(
            ...
            metavar="<admin_state_up>",
            type=bool,
            help=_("Specifies the administrative status of the " "Virtual Gateway."),
        )
        return parser
...
class UpdateVirtualGateway(command.ShowOne):
    ...
    def take_action(self, parsed_args):
        ...
        args_list = ["name", "description", "local_ep_group_id"]
        attrs = {}
        for arg in args_list:
            val = getattr(parsed_args, arg)
            if val:
        ...
        if parsed_args.virtual_gateway:
            virtual_gateway = client.find_virtual_gateway(parsed_args.virtual_gateway)
            obj = client.update_virtual_gateway(virtual_gateway.id, **attrs)
