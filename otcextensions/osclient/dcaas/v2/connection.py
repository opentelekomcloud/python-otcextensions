...
class ListDirectConnections(command.Lister):
    ...
    columns = ("id", "name", "port type", "provider", "bandwidth", "location", "status")

    def get_parser(self, prog_name):
        parser = super(ListDirectConnections, self).get_parser(prog_name)
        parser.add_argument(
            "--id", metavar="<id>", help=_("Specifies the ID of the Direct Connection.")
        )
        parser.add_argument(
            "--name",
            metavar="<name>",
        ...
        parser.add_argument(
            ...
            metavar="<port_type>",
            help=_(
                "Specified the port type of Direct Connection. The value "
                "can be 1G or 10G."
            ),
        )
        parser.add_argument(
        ...
        parser.add_argument(
            ...
            help=_(
                "Specifies the location of the on-premises facility at "
        ...
        parser.add_argument(
            ...
            help=_(
                "Specifies the name of the interface accessed by the "
                "Direct Connection."
            ),
        )
        parser.add_argument(
            ...
            help=_(
                "Specifies the ID of the redundant connection using "
                "the same gateway."
            ),
        )
        parser.add_argument(
        ...
        parser.add_argument(
            ...
            metavar="<hosting_id>",
            help=_(
                "Specifies the ID of the operations connection on which"
        ...
        parser.add_argument(
            "--vlan",
            metavar="<vlan>",
            help=_("Specifies the VLAN pre-allocated to the hosted" " connection."),
        )
        parser.add_argument(
            "--charge_mode",
            metavar="<charge_mode>",
        ...
        parser.add_argument(
            ...
            metavar="<status>",
            help=_(
                "Specifies the connection status. The value can be ACTIVE, "
...
class UpdateDirectConnection(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "--name", metavar="<name>", help=_("Specifies the connection name.")
        )
        parser.add_argument(
            "--description",
            metavar="<description>",
    ...
    def take_action(self, parsed_args):
        ...
        if parsed_args.direct_connection:
            direct_connection = client.find_connection(parsed_args.direct_connection)
            obj = client.update_connection(direct_connection.id, **attrs)
