...
class ListNatGateways(command.Lister):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            help=_(
                "Specifies the network ID of the downstream "
        ...
        parser.add_argument(
            ...
            help=_(
                "Specifies whether the NAT Gateway is enabled "
        ...
        parser.add_argument(
            ...
            metavar="<created_at>",
            help=_(
                "Specifies when the NAT Gateway is created (UTC time). "
...
class CreateNatGateway(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "--description",
            metavar="<description>",
            help=_("Provides supplementary information about " "the NAT Gateway."),
        )
        parser.add_argument(
            "--spec",
            metavar="<spec>",
    ...
    def take_action(self, parsed_args):
        ...
        for gateway in parsed_args.gateway:
            try:
                ...
                LOG.error(
                    _(
                        "Failed to delete Nat Gateway with "
        ...
        if result > 0:
            ...
            msg = _("%(result)s of %(total)s NAT Gateway(s) failed " "to delete.") % {
                "result": result,
                "total": total,
            }
