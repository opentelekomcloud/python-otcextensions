...
class CreateConfiguration(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "--name", metavar="<name>", required=True, help=_("Parameter group name")
        )
        parser.add_argument(
            "--description",
            metavar="<description>",
        ...
        parser.add_argument(
            ...
            help=_("Parameter group value" "(repeat option to set multiple values)"),
        )
        parser.add_argument(
            "values",
            metavar="<values>",
    ...
    def take_action(self, parsed_args):
        ...
        try:
            ...
            msg = _("Failed to parse configuration values: %(e)s") % {"e": e}
...
class SetConfiguration(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "--name", metavar="<name>", help=_("New ParameterGroup name")
        )
        parser.add_argument(
            "--description",
            metavar="<description>",
    ...
    def take_action(self, parsed_args):
        ...
        if not config:
            msg = (
                _("Failed to find Parameter Group by ID %s")
...
class DeleteConfiguration(command.Command):
    ...
    def take_action(self, parsed_args):
        ...
        try:
            configuration = client.find_configuration(parsed_args.configuration_group)
