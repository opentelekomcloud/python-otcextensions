...
class ListDatabaseInstances(command.Lister):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            type=str,
            help=_(
                "Specifies the ID of Router to which "
    ...
    def take_action(self, parsed_args):
        ...
        args_list = ["name", "id", "router_id", "network_id", "offset", "limit"]
        attrs = {}
...
class CreateDatabaseInstance(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument("flavor", metavar="<flavor>", help=_("Flavor spec_code"))
        ...
        new_instance_group.add_argument(
            "--port", metavar="<port>", type=int, help=_("Database Port")
        )
        new_instance_group.add_argument(
            "--password",
            metavar="<password>",
        ...
        create_from_group.add_argument(
            ...
            metavar="<source_instance>",
            help=_(
                "Source instance ID or Name to create from. "
        ...
        create_from_group.add_argument(
            ...
            metavar="<HH:MM-HH:MM>",
            help=_(
                "Specifies the backup time window. Automated backups will "
        ...
        create_from_group.add_argument(
            ...
            metavar="<time>",
            help=_(
                "Time (UNIX timestamp in ms) to create new instance "
        ...
        parser.add_argument("--wait-timeout", type=int, help=_("Timeout"))
    ...
    def take_action(self, parsed_args):
        ...
        obj = client.create_rds_instance(**attrs)
...
class DeleteDatabaseInstance(command.Command):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "--wait", action="store_true", help=_("Wait for the instance to be deleted")
        )
        parser.add_argument(
            "--wait-interval", type=int, help=_("Interval for checking status")
        )
    ...
    def take_action(self, parsed_args):
        ...
        client = self.app.client_manager.sdk_connection
        attrs = {}
        for attr in ["instance", "wait", "wait_timeout", "wait_interval"]:
            if getattr(parsed_args, attr):
                attrs[attr] = getattr(parsed_args, attr)
    ...
    def take_action(self, parsed_args):
        ...
        if parsed_args.backup:
            backup = client.find_backup(
                name_or_id=parsed_args.backup, instance=instance, ignore_missing=False
            )

        obj = client.restore_instance(
            instance=instance, backup=backup, restore_time=parsed_args.restore_time
        )
...
class ShowBackupPolicy(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "instance", metavar="<instance>", help=_("Instance ID or Name")
        )
        return parser
