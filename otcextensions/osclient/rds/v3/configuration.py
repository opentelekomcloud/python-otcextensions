...
class ShowConfiguration(command.ShowOne):
    ...
    def take_action(self, parsed_args):
        ...
        obj = client.find_configuration(parsed_args.configuration, ignore_missing=False)
...
class ListConfigurationParameters(command.Lister):
    ...
    def take_action(self, parsed_args):
        ...
        data = client.find_configuration(
            parsed_args.configuration, ignore_missing=False
...
class CreateConfiguration(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument("name", metavar="<name>", help=_("Parameter group name"))
        parser.add_argument(
            "--description",
            metavar="<description>",
        ...
        parser.add_argument(
            ...
            help=_("Configuration value" "(repeat option to set multiple values)"),
        )
...
class ApplyConfiguration(command.Lister):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            required=True,
            help=_(
                "ID of the instance the configuration "
    ...
    def take_action(self, parsed_args):
        ...
        config = client.find_configuration(
            parsed_args.configuration, ignore_missing=False
        )
...
class SetConfiguration(command.Command):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "configuration", metavar="<configuration>", help=_("Configuration id")
        )
        parser.add_argument(
            "--name", metavar="<name>", help=_("New Configuration name")
        )
        parser.add_argument(
            "--description",
            metavar="<description>",
