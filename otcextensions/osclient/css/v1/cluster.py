...
class CreateCluster(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        disk_group.add_argument(
            ...
            default=40,
            type=int,
            help=_("Size of the instance disk volume in GB. " "(default value: 40)"),
        )
        disk_group.add_argument(
            "--volume-type",
    ...
    def take_action(self, parsed_args):
        ...
        if parsed_args.wait:
            client.wait_for_cluster(cluster.id, parsed_args.timeout, print_status=True)
...
class ListClusterNodes(command.Lister):
    ...
    def take_action(self, parsed_args):
        ...
        return (
            self.columns,
            (
                utils.get_item_properties(node, self.columns, formatters=_formatters)
...
class ListClusterVersionUpgrades(command.Lister):
    ...
    def take_action(self, parsed_args):
        ...
        obj = client.get_cluster_version_upgrades(cluster, parsed_args.upgrade_type)
