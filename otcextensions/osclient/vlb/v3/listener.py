...
def _add_tags_to_listener_obj(obj, data, columns):
    data += (
        "\n".join((f'value={tag["value"]}, key={tag["key"]}' for tag in obj.tags)),
    )
...
class ListListeners(command.Lister):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument("--id", help=_("Specifies the listener ID."))
        parser.add_argument(
            "--name",
            metavar="<name>",
            help=_("Specifies the name of the listener added" "to the load balancer."),
        )
        parser.add_argument(
            "--protocol-port",
        ...
        parser.add_argument(
            ...
            type=bool,
            help=_(
                "Specifies whether to use HTTP/2. This parameter"
        ...
        parser.add_argument(
            ...
            help=_("Specifies the private IP address bound" "to the backend server."),
        )
        parser.add_argument(
            "--member-device-id",
            metavar="<member_device_id>",
            help=_(
                "Specifies the ID of the cloud server that serves"
                "as a backend server."
            ),
        )
        parser.add_argument(
            ...
            type=bool,
            help=_(
                "Specifies whether to enable health check retries"
                "for backend servers."
            ),
        )
        parser.add_argument(
            ...
            help=_(
                "Specifies the timeout duration for waiting for a request"
        ...
        parser.add_argument(
            ...
            type=bool,
            help=_(
                "Specifies whether to pass source IP addresses"
                "of the clients to backend servers."
            ),
        )
        parser.add_argument(
            "--limit", type=int, help=_("Specifies the number of records on each page.")
        )
        parser.add_argument(
            "--marker",
            help=_(
    ...
    def take_action(self, parsed_args):
        ...
        if parsed_args.default_tls_container_ref:
            args["default_tls_container_ref"] = parsed_args.default_tls_container_ref
...
class ShowListener(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "listener", metavar="<listener>", help=_("ID or name of the listener")
        )
        return parser
    ...
    def take_action(self, parsed_args):
        ...
        obj = client.find_listener(
            name_or_id=parsed_args.listener, ignore_missing=False
        )

        data = utils.get_dict_properties(_flatten_listener(obj), self.columns)
...
class CreateListener(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "--name", metavar="<name>", help=_("Name of the load balancer")
        )
        parser.add_argument(
            "--client-ca-tls-container-ref",
            metavar="<client_ca_tls_container_ref>",
            help=_("Specifies the ID of the CA certificate" "used by the listener."),
        )
        parser.add_argument(
            "--default-pool-id",
            metavar="<default_pool_id>",
        ...
        parser.add_argument(
            "--project-id", metavar="project_id", help=_("Specifies the project ID.")
        )
        parser.add_argument(
            "--protocol",
            required=True,
        ...
        parser.add_argument(
            ...
            help=_(
                "Lists the IDs of SNI certificates (server certificates"
        ...
        parser.add_argument(
            ...
            help=_(
                "Specifies how wildcard domain name matches with the SNI"
        ...
        parser.add_argument(
            ...
            help=_(
                "List of tags. Repeat option for "
                "multiple tags.\n"
                "Example:\n"
        ...
        parser.add_argument(
            ...
            help=_(
                "Specifies the security policy that will be used"
        ...
        parser.add_argument(
            ...
            action="store_true",
            help=_(
                "Specifies whether to enable health check retries for"
        ...
        parser.add_argument(
            ...
            type=int,
            help=_(
                "Specifies the timeout duration for waiting for"
        ...
        parser.add_argument(
            ...
            metavar="<ipgroup_id>",
            help=_(
                "Specifies the ID of the IP address group associated with"
                "the listener."
            ),
        )
        parser.add_argument(
    ...
    def take_action(self, parsed_args):
        ...
        if parsed_args.default_tls_container_ref:
            attrs["default_tls_container_ref"] = parsed_args.default_tls_container_ref
        if parsed_args.description:
        ...
        if obj.tags:
            data, self.columns = _add_tags_to_listener_obj(obj, data, self.columns)
        if obj.load_balancers:
            data, self.columns = _add_loadbalancers_to_listener_obj(
                obj, data, self.columns
            )
...
class UpdateListener(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument("listener", help=_("Specifies listener name of id."))
        parser.add_argument("--name", help=_("Specifies the new name."))
        parser.add_argument(
            "--client-ca-tls-container-ref",
            metavar="<client_ca_tls_container_ref>",
            help=_("Specifies the ID of the CA certificate" "used by the listener."),
    ...
    def take_action(self, parsed_args):
        ...
        if parsed_args.member_timeout:
            attrs["member_timeout"] = parsed_args.member_timeout
        if (
            parsed_args.ipgroup_id
            or parsed_args.enable_ipgroup
            or parsed_args.ipgroup_type
        ):
            attrs["ipgroup"] = {}
            if parsed_args.ipgroup_id:
                attrs["ipgroup"]["ipgroup_id"] = parsed_args.ipgroup_id
...
class DeleteListener(command.Command):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument("listener", help=_("ID or name of the listener"))
        return parser
    ...
    def take_action(self, parsed_args):
        ...
        self.app.client_manager.vlb.delete_listener(
            listener=listener.id, ignore_missing=False
        )
