...
class ListLoadBalancers(command.Lister):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "--id", required=False, help=_("Specifies the load balancer ID.")
        )
        parser.add_argument("--name", help=_("Specifies the load balancer name."))
        parser.add_argument(
            "--marker",
            metavar="<marker>",
        ...
        parser.add_argument(
            ...
            dest="guaranteed",
            help=_(
                "Specifies whether the load balancer is a dedicated"
        ...
        parser.add_argument(
            ...
            dest="vip_port_id",
            help=_(
                "Specifies the ID of the port bound to the virtual"
        ...
        parser.add_argument(
            "--ip-address",
            dest="vip_address",
            help=_("Specifies the virtual IP address bound" " to the load balancer."),
        )
        parser.add_argument(
            "--subnet-id",
            dest="vip_subnet_cidr_id",
            help=_("Specifies the ID of the subnet where the" " load balancer works."),
        )
        parser.add_argument(
            "--eip",
            dest="eips",
        ...
        parser.add_argument(
            ...
            help=_("Specifies the list of AZs where the load balancer" "is created."),
        )
        parser.add_argument(
            "--l4-flavor-id",
        ...
        parser.add_argument(
            ...
            help=_(
                "Specifies the ID of the cloud server that serves as"
                "a backend server."
            ),
        )
        parser.add_argument(
...
class ShowLoadBalancer(command.ShowOne):
    ...
    def take_action(self, parsed_args):
        ...
        obj = client.find_load_balancer(
            name_or_id=parsed_args.loadbalancer, ignore_missing=False
        )

        data = utils.get_dict_properties(_flatten_loadbalancer(obj), self.columns)
        if obj.eips:
            data, self.columns = _add_eips_to_load_balancer_obj(obj, data, self.columns)
        if obj.floating_ips:
        ...
        if obj.tags:
            data, self.columns = _add_tags_to_load_balancer_obj(obj, data, self.columns)
...
class CreateLoadBalancer(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            action="append",
            help=_(
                "Specifies the ID of the EIP the system will automatically"
        ...
        parser.add_argument(
            ...
            type=int,
            help=_(
                "Specifies the IP address version for public ip."
        ...
        parser.add_argument(
            ...
            action="append",
            help=_(
                "ID of the subnet on the downstream plane."
        ...
        parser.add_argument(
            ...
            action="store_true",
            help=_(
                "Specifies whether to enable deletion protection for"
                "the load balancer."
            ),
        )
        return parser
    ...
    def take_action(self, parsed_args):
        ...
        attrs["availability_zone_list"] = parsed_args.availability_zone_list
        ...
        if parsed_args.deletion_protection_enable is not None:
            attrs["deletion_protection_enable"] = parsed_args.deletion_protection_enable

        if (
            parsed_args.network_type
            or parsed_args.publicip_billing_info
            or parsed_args.ip_version
            or parsed_args.bandwidth
            ...
            if parsed_args.ip_version_publicip:
                attrs["publicip"]["ip_version"] = parsed_args.ip_version_publicip
...
class UpdateLoadBalancer(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument("--name", help=_("New name of the load balancer."))
        parser.add_argument(
            "--description",
            metavar="<description>",
            help=_("Provides supplementary information" "about the load balancer."),
        ...
        parser.add_argument(
            ...
            dest="vip_subnet_cidr_id",
            help=_(
                "Specifies the ID of the IPv4 subnet where"
    ...
    def take_action(self, parsed_args):
        ...
        if attrs:
            obj = client.update_load_balancer(loadbalancer=loadbalancer.id, **attrs)
        else:
            obj = loadbalancer
...
class DeleteLoadBalancer(command.Command):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument("loadbalancer", help=_("ID or name of the load balancer"))
        return parser
    ...
    def take_action(self, parsed_args):
        ...
        self.app.client_manager.vlb.delete_load_balancer(
            load_balancer=loadbalancer.id, ignore_missing=False
        )
