...
class ListTrace(command.Lister):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "--trace_id", metavar="<id>", help=_("Trace id to query traces for.")
        )
        parser.add_argument(
            "--level",
        ...
        parser.add_argument(
            "--user", metavar="<user>", help=_("User name to query traces for.")
        )
        parser.add_argument(
            "--start_time",
        ...
        parser.add_argument(
            "--long", action="store_true", help=_("Return long format.")
        )
        return parser
    ...
    def take_action(self, parsed_args):
        ...
        if parsed_args.start_time:
            query["from"] = format.TimeTMsStr().serialize(parsed_args.start_time)
