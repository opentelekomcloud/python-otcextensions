...
class ListCCEClusterNode(command.Lister):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "cluster", metavar="<cluster>", help=_("The ID or name of the cluster.")
        )
...
class ShowCCEClusterNode(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "cluster", metavar="<cluster>", help=_("ID of the cluster.")
        )
        parser.add_argument("node", metavar="<node>", help=_("ID of the cluster node."))
        return parser
    ...
    def take_action(self, parsed_args):
        ...
        obj = client.find_cluster_node(cluster=cluster.id, node=parsed_args.node)

        flat_data = _flatten_cluster_node(obj)
        columns = tuple(flat_data)

        data = utils.get_dict_properties(flat_data, columns)
...
class DeleteCCEClusterNode(command.Command):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "node", metavar="<node>", nargs="+", help=_("Name of the cluster node.")
        )
        return parser
    ...
    def take_action(self, parsed_args):
        ...
        if parsed_args.cluster and parsed_args.node:
            ...
            for node in parsed_args.node:
                obj = client.find_cluster_node(cluster=cluster.id, node=node)
                client.delete_cluster_node(
                    cluster=cluster.id, node=obj.id, ignore_missing=False
                )
...
class CreateCCEClusterNode(command.Command):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "cluster", metavar="<cluster>", help=_("ID or name of the CCE cluster.")
        )
        parser.add_argument(
            "--name",
            metavar="<name>",
            help=_(
                "Name of the CCE node.\nThe clustername and a random "
        ...
        parser.add_argument(
            ...
            dest="annotations",
            help=_(
                "Annotations in form of key, value pairs."
        ...
        parser.add_argument(
            ...
            type=int,
            help=_(
                "Bandwidth of the floating ip being created. fip-count"
        ...
        parser.add_argument(
            ...
            action="append",
            help=_(
                "Address or ID of the existing floating IP to be "
        ...
        parser.add_argument(
            ...
            type=int,
            help=_(
                "Count of floating IP addresses being attached to one "
        ...
        parser.add_argument(
            ...
            dest="k8s_tags",
            help=_(
                "Kubernetes tags in form of key, value pairs. Repeat "
        ...
        parser.add_argument(
            ...
            dest="labels",
            help=_(
                "Option labels in form of key, value pairs. Repeat "
        ...
        parser.add_argument(
            ...
            metavar="<network>",
            required=True,
            help=_("ID or name of the network where the node will be " "created."),
        )
        parser.add_argument(
            "--node-image-id",
        ...
        parser.add_argument(
            ...
            help=_(
                "List of tags used to build UI labels. Repeat option for "
                "multiple tags.\n"
                "Example:\n"
        ...
        parser.add_argument(
            ...
            default=5,
            help=_(
                "Check interval in seconds for successful creation check"
        ...
        parser.add_argument(
            ...
            default=3600,
            help=_(
                "Maximum time in seconds to wait for successful creation"
                "when param wait is True."
            ),
        )
        return parser
    ...
    def take_action(self, parsed_args):
        ...
        obj = self.app.client_manager.sdk_connection.create_cce_cluster_node(**attrs)
