...
class ListInstance(command.Lister):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument("--name", metavar="<name>", help=_("DCS instance name."))
        parser.add_argument(
            "--status",
        ...
        parser.add_argument(
            ...
            action="store_true",
            help=_(
                "An indicator of whether the number of DCS instances "
        ...
        parser.add_argument(
            ...
            action="store_true",
            help=_(
                "An indicator of whether to perform an exact or fuzzy "
...
class ShowInstance(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "instance", metavar="<instance>", help=_("Name or UUID of the instance.")
        )
    ...
    def take_action(self, parsed_args):
        ...
        obj = client.find_instance(name_or_id=parsed_args.instance)
...
class CreateInstance(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            required=True,
            help=_(
                "DCS instance name. An instance name is a string of "
        ...
        parser.add_argument(
            ...
            metavar="<description>",
            help=_(
                "Brief description of the DCS instance. A brief "
        ...
        parser.add_argument(
            ...
            help=_(
                "Cache capacity. Unit: GB. For a single-node DCS instance "
        ...
        parser.add_argument(
            ...
            required=True,
            help=_(
                "Password of a DCS instance. Password complexity "
                "requirements:\n"
        ...
        parser.add_argument(
            "--subnet_id", metavar="<id>", required=True, help=_("Subnet ID.")
        )
        parser.add_argument(
            "--az", metavar="<az>", required=True, help=_("Availability zone.")
        )
        parser.add_argument(
            "--product_id",
...
class SetInstance(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "--security_group_id", metavar="<id>", help=_("Tenant's security group ID.")
        )
        parser.add_argument(
            "--backup_policy",
            metavar="<json>",
...
class ExtendInstance(command.ShowOne):
    ...
    def take_action(self, parsed_args):
        ...
        obj = client.extend_instance(instance=inst.id, capacity=parsed_args.capacity)
...
class ChangePasswordInstance(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "--current_password", metavar="<pwd>", help=_("Current instance password")
        )
        parser.add_argument(
            "--new_password",
            metavar="<pwd>",
            help=_(
                "New password of a DCS instance. Password complexity "
                "requirements:\n"
                "* A string of 8-32 characters.\n"
                "* Contains at least three types of the following "
                "characters:\n"
