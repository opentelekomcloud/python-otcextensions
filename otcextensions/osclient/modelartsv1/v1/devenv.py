...
class ListDevEnvInstances(command.Lister):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            metavar='<de_type>',
            default='Notebook',
            help=_('Development environment type. Only Notebook is supported. '
        ...
        parser.add_argument(
            ...
            metavar='<sort_by>',
            dest='sortby',
            help=_('Classification standard. The value can be name '
                   'or creation_timestamp. By default list is sorted by name.')
        )
        parser.add_argument(
            '--order',
            metavar='<order>',
            help=_('Sorting mode. The value can be asc or desc. '
    ...
    def take_action(self, parsed_args):
        ...
        return (
            ...
            (utils.get_item_properties(
                s,
                self.columns,
                formatters=formatters) for s in data))
...
class CreateDevEnvInstance(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            'name',
            metavar='<name>',
            help=_('Instance name (max 64 characters). The value can contain '
        ...
        parser.add_argument(
            ...
            required=True,
            type=int,
            help=_('Configuration ID. The options are as follows:\n'
                   '1: Multi-Engine 1.0 (python3)-cpu\n'
                   '2: Multi-Engine 1.0 (python3)-gpu\n'
                   '3: Multi-Engine 2.0 (python3)\n'
        ...
        parser.add_argument(
            ...
            required=True,
            help=_('The value must be a valid OBS bucket path and end with '
        ...
        extended_storage_group = parser.add_argument_group(
            ...
            description=_('Extended storage supports only obs fs and is '
        ...
        extended_storage_group.add_argument(
            ...
            help=_('If extended_storage_type is set to obs, this parameter is '
        ...
        autostop_group.add_argument(
            ...
            type=int,
            help=_('Running duration, in seconds. The value ranges from '
        ...
        autostop_group.add_argument(
            ...
            type=bool,
            help=_('Whether to display a prompt again.\nThis parameter is '
        ...
        parser.add_argument(
            ...
            help=_('Custom data to be passed as Map<String:String>.\nData may '
    ...
    def take_action(self, parsed_args):
        ...
        for name_or_id in parsed_args.instance:
            try:
                ...
                result += 1
                LOG.error(_("Failed to delete DevEnv Instance(s) with "
                          "ID or Name '%(instance)s': %(e)s"),
                          {'instance': name_or_id, 'e': e})
        if result > 0:
            total = len(parsed_args.instance)
            msg = (_("%(result)s of %(total)s DevEnv Instance(s) failed "
