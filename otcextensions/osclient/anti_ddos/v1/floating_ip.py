...
class ListFloatingIP(command.Lister):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument("--ip", metavar="<IP>", help=_("Floating IP prefix."))
        parser.add_argument(
            "--status",
...
class ShowFloatingIP(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "floating_ip_id", metavar="<ID>", help=_("UUID of the floating IP.")
        )
...
class SetFloatingIP(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            required=True,
            help=_(
                "Position ID of number of access limit during cleaning. "
        ...
        l7_group.add_argument(
            "--disable_l7", action="store_true", help=_("Disable L7 defence.")
        )
    ...
    def take_action(self, parsed_args):
        ...
        if parsed_args.cleaning_access_pos_id:
            attrs["cleaning_access_pos_id"] = parsed_args.cleaning_access_pos_id
