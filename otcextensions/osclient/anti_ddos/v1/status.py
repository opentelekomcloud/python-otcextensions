...
class ListFloatingIPEvents(command.Lister):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "floating_ip", metavar="<UUID>", help=_("UUID of the floating IP.")
        )
    ...
    def take_action(self, parsed_args):
        ...
        data = client.floating_ip_events(floating_ip_id=parsed_args.floating_ip)
...
class ListFloatingIPStatDay(command.Lister):
    ...
    def take_action(self, parsed_args):
        ...
        data = client.floating_ip_stat_day(floating_ip_id=parsed_args.floating_ip)
...
class ListFloatingIPStatWeek(command.Lister):
    ...
    def take_action(self, parsed_args):
        ...
        table = (
            self.columns,
            (utils.get_item_properties(s, self.columns) for s in data.weekdata),
        )
        return table
