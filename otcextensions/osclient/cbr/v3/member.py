...
class ListMembers(command.Lister):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument("backup", metavar="<backup>", help=_("Backup name or id."))
        parser.add_argument(
            "--dest-project-id",
        ...
        parser.add_argument(
            "--status", metavar="<status>", help=_("Status of a shared backup.")
        )
        parser.add_argument(
            "--vault-id",
            metavar="<vault_id>",
...
class ShowMember(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            metavar="<member_id>",
            help=_(
                "Member ID, which is the project ID of the tenant"
    ...
    def take_action(self, parsed_args):
        ...
        backup = client.find_backup(name_or_id=parsed_args.backup, ignore_missing=False)
        obj = client.get_member(member=parsed_args.member, backup=backup.id)

        data = utils.get_dict_properties(_flatten_member(obj), self.columns)
...
class UpdateMember(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            metavar="vault_id",
            help=_(
                "Specifies the vault in which the shared backup is"
    ...
    def take_action(self, parsed_args):
        ...
        if attrs:
            obj = client.update_member(
                backup=parsed_args.backup, member=parsed_args.member, **attrs
            )
...
class DeleteMember(command.Command):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument("backup", help=_("Backup name or id."))
        parser.add_argument("member", help=_("Member id."))
    ...
    def take_action(self, parsed_args):
        ...
        self.app.client_manager.cbr.delete_member(
            backup=backup.id, member=parsed_args.member, ignore_missing=False
        )
