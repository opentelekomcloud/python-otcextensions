...
class ListDatasource(command.Lister):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "--type", metavar="<type>", help=_("type of the datasource")
        )
        parser.add_argument(
            "--limit",
            metavar="<limit>",
...
class DeleteDatasource(command.Command):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument("id", metavar="<id>", nargs="+", help=_("Data source ID"))
...
class CreateDatasource(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "--name", metavar="<name>", required=True, help=_("Name for the datasource")
        )
        parser.add_argument(
            "--is_public",
            action="store_const",
        ...
        parser.add_argument(
            "--type", metavar="<type>", required=True, help=_("Data source type")
        )
        parser.add_argument(
            "--url", metavar="<url>", required=True, help=_("Data source URL")
        )
        parser.add_argument(
            "--description", metavar="<description>", help=_("Data source description")
        )
    ...
    def take_action(self, parsed_args):
        ...
        obj = client.create_datasource(**attrs)
...
class UpdateDatasource(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "--name", metavar="<name>", help=_("Name for the data source")
        )
        parser.add_argument(
            "--is_public",
            action="store_const",
        ...
        parser.add_argument("--type", metavar="<type>", help=_("Data source type"))
        parser.add_argument("--url", metavar="<url>", help=_("Data source URL"))
        parser.add_argument(
            "--description", metavar="<description>", help=_("Data source description")
        )
    ...
    def take_action(self, parsed_args):
        ...
        datasource = client.find_datasource(
            parsed_args.datasource, ignore_missing=False
        )
        if attrs:
            obj = client.update_datasource(datasource=datasource, **attrs)
        else:
            obj = datasource
        display_columns, columns = _get_columns(obj)
        data = utils.get_item_properties(obj, columns)
...
class ShowDatasource(command.ShowOne):
    ...
    def take_action(self, parsed_args):
        ...
        obj = client.find_datasource(parsed_args.datasource, ignore_missing=False)
