...
class ListCluster(command.Lister):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "--marker", metavar="<marker>", help=_("Current page number.")
        )
        return parser
...
class ShowCluster(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "cluster", metavar="<cluster>", help=_("ID or name of the MRS cluster.")
        )
        return parser
    ...
    def take_action(self, parsed_args):
        ...
        obj = client.find_cluster(name_or_id=parsed_args.cluster, ignore_missing=False)

        data = utils.get_dict_properties(_flatten_cluster(obj), self.columns)

        if obj.tags:
            data, self.columns = _add_tags_to_cluster_obj(obj, data, self.columns)
...
class ListClusterHost(command.Lister):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "cluster_id", metavar="<cluster_id>", help=_("id of the cluster.")
        )
...
class UpdateCluster(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "cluster", metavar="<cluster>", help=_("ID or Name of the cluster.")
        )
        parser.add_argument(
            "--scale_type",
            metavar="<scale_type>",
        ...
        parser.add_argument(
            ...
            type=bool,
            help=_(
                "Whether to start components on the added "
        ...
        parser.add_argument(
            ...
            action="append",
            help=_(
                "Task node to be deleted during task node scale-in."
                "Repeat for multiple values."
            ),
        )
        parser.add_argument(
            ...
            metavar="<node_size>",
            help=_(
                "Instance specifications of a Task node."
        ...
        parser.add_argument(
            ...
            type=int,
            help=_("Number of data disks of a Task node." "Value range: 1 to 10."),
        )
        parser.add_argument(
            "--data_volume_size",
    ...
    def take_action(self, parsed_args):
        ...
        cluster = client.find_cluster(
            name_or_id=parsed_args.cluster, ignore_missing=False
        )
