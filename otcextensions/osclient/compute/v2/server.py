...
class SetServer(command.Command):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            metavar="<description>",
            help=_(
                "New server description (supported by "
        ...
        parser.add_argument(
            ...
            metavar="<tag>",
            action="append",
            help=_("New Tag (supported by --os-compute-api-version 2.26 and " "above"),
        )
        return parser
    ...
    def take_action(self, parsed_args):
        ...
        if parsed_args.properties:
            compute_client.set_server_metadata(server, **parsed_args.properties)
...
class UnsetServer(command.Command):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            action="append",
            help=_(
                "Unset tag (supported by --os-compute-api-version 2.26 and " "above"
            ),
        )
        return parser
