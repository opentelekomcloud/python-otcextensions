...
STORAGE_SPEC_CHOICES = ["dms.physical.storage.high", "dms.physical.storage.ultra"]
...
class ListDMSInstance(command.Lister):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument("--engine-name", metavar="<engine>", help=_("Engine name"))
...
class DeleteDMSInstance(command.Command):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "instance", metavar="<instance>", nargs="+", help=_("ID of the Instance")
        )
        return parser
...
class CreateDMSInstance(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            required=True,
            help=_(
                "Indicates the message storage space with increments "
                "of 100 GB:\n"
        ...
        parser.add_argument(
            "--router", metavar="<router>", required=True, help=_("Router ID or Name")
        )
        parser.add_argument(
            "--security-group",
            metavar="<sg>",
        ...
        parser.add_argument(
            ...
            help=_(
                "Action to be taken when the memory usage reaches the "
        ...
        parser.add_argument(
            ...
            help=_(
                "The storage I/O specification of a Kafka instance.\n"
    ...
    def take_action(self, parsed_args):
        ...
        router_obj = network_client.find_router(
            parsed_args.router, ignore_missing=False
        )
        attrs["router_id"] = router_obj.id
        net_obj = network_client.find_network(parsed_args.network, ignore_missing=False)
...
class UpdateDMSInstance(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "instance", metavar="<inst>", help=_("Name or ID of the DMS instance")
        )
        parser.add_argument(
            "--name", metavar="<name>", help=_("New name of the instance.")
        )
        parser.add_argument(
            "--description",
            metavar="<description>",
