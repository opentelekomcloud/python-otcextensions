...
class ListDMSInstanceTopic(command.Lister):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "instance", metavar="<instance>", help=_("DMS Instance name or ID")
        )
        return parser
    ...
    def take_action(self, parsed_args):
        ...
        instance_obj = client.find_instance(parsed_args.instance, ignore_missing=False)
...
class DeleteDMSInstanceTopic(command.Command):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "instance", metavar="<instance>", help=_("ID or name of the Instance")
        )
        parser.add_argument("topic", metavar="<topic>", nargs="+", help=_("Topic ID"))
        return parser
...
class CreateDMSInstanceTopic(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument("id", metavar="<id>", help=_("Name/ID of the topic."))
        parser.add_argument(
            "--partition",
            metavar="<part>",
            type=int,
