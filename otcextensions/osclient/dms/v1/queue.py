...
class DeleteDMSQueue(command.Command):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "queue", metavar="<queue>", nargs="+", help=_("ID of the queue")
        )
        return parser
...
class CreateDMSQueue(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            help=_(
                "This parameter is mandatory only when queue_mode is "
                "NORMAL or FIFO.\n"
        ...
        parser.add_argument(
            ...
            type=int,
            help=_(
                "This parameter is mandatory only when redrive_policy "
                "is set to enable.\n"
    ...
    def take_action(self, parsed_args):
        ...
        if parsed_args.queue_mode:
            ...
            if mode in ("NORMAL", "FIFO", "KAFKA_HA", "KAFKA_HT"):
                ...
                msg = _("Queue mode is not in (NORMAL, FIFO, KAFKA_HA, " "KAFKA_HT)")
