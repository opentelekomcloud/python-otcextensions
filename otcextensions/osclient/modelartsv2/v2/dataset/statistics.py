...
class Statistics(command.ShowOne):
    _description = _("Show statistics of a Modelarts dataset.")

    def get_parser(self, prog_name):
        parser = super(Statistics, self).get_parser(prog_name)
        parser.add_argument(
            "datasetId",
            metavar="<datasetId>",
            help=_("Dataset ID."),
    ...
    def take_action(self, parsed_args):
        ...
        data = client.get_dataset_statistics(parsed_args.datasetId)
