...
class DownloadData(command.Lister):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            required=True,
            help=_(
                "Data cursor, which needs to be obtained through the API "
        ...
        parser.add_argument(
            ...
            help=_(
                "Maximum number of bytes that can be obtained for each "
                "request."
...
class ShowDataCursor(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            help=_(
                "Sequence number. A sequence number is the unique "
        ...
        parser.add_argument(
            ...
            type=int,
            help=_(
                "Timestamp when the data record starts to be read, which "
    ...
    def take_action(self, parsed_args):
        ...
        obj = client.get_data_cursor(
            parsed_args.streamName, parsed_args.partition_id, **params
        )
...
class UploadData(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            metavar="<stream_id>",
            help=_(
                "Unique ID of the stream. If no stream is found based on "
        ...
        parser.add_argument(
            ...
            metavar="<data>",
            help=_(
                "Data to be uploaded. The uploaded data is the serialized "
