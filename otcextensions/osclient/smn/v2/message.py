...
class PublishMessage(command.ShowOne):
    _description = _(
        "Publish message. Three message formats are supported:\n"
        "- message\n"
        "- message_structure\n"
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            required=True,
            help=_(
                "Message content. The message content is a UTF-8-coded "
        ...
        parser.add_argument(
            ...
            help=_(
                "Message structure, which contains JSON character "
        ...
        parser.add_argument(
            ...
            help=_(
                "Message template name, which can be obtained "
    ...
    def take_action(self, parsed_args):
        ...
        args_list = ["subject", "time_to_live", "message", "message_template_name"]
        attrs = {}
