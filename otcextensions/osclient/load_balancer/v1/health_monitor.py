...
class ListHealthMonitor(command.Lister):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            choices=TYPE_VALUES,
            help=_(
                "Health monitor type to use as a filter\n"
...
class ShowHealthMonitor(command.ShowOne):
    ...
    def take_action(self, parsed_args):
        ...
        obj = client.find_health_monitor(
            name_or_id=parsed_args.health_monitor, ignore_missing=False, **args
        )
...
class CreateHealthMonitor(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "--name", metavar="<name>", help=_("Set the health monitor name.")
        )
        parser.add_argument(
            "--delay",
            metavar="<delay>",
            type=int,
            required=True,
            help=_("Set the time in seconds, between sending probes " "to members."),
        )
        parser.add_argument(
            "--expected_codes",
            metavar="<codes>",
        ...
        parser.add_argument(
            ...
            metavar="<url_path>",
            help=_(
                "The HTTP URL path of the request sent by the monitor "
    ...
    def take_action(self, parsed_args):
        ...
        pool = client.find_pool(name_or_id=parsed_args.pool, ignore_missing=False)

        args["pool_id"] = pool.id

        obj = client.create_health_monitor(**args)
...
class SetHealthMonitor(command.ShowOne):
    ...
    def take_action(self, parsed_args):
        ...
        hm = client.find_health_monitor(
            name_or_id=parsed_args.health_monitor, ignore_missing=False
        )
...
class DeleteHealthMonitor(command.Command):
    ...
    def take_action(self, parsed_args):
        ...
        for hm in parsed_args.health_monitor:
            obj = client.find_health_monitor(name_or_id=hm, ignore_missing=False)
            client.delete_health_monitor(health_monitor=obj.id, ignore_missing=False)
