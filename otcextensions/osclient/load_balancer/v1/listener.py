...
class ListListener(command.Lister):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "--name", metavar="<name>", help=_("List listeners by listener name.")
        )
        parser.add_argument(
            "--load_balancer",
        ...
        parser.add_argument(
            ...
            help=_(
                "Load balancer listener protocol to query\n"
...
class ShowListener(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "listener", metavar="<listener>", help=_("Name or UUID of the listener.")
        )
...
class CreateListener(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "--name", metavar="<name>", help=_("Set the listener name.")
        )
        parser.add_argument(
            "--description",
            metavar="<description>",
        ...
        parser.add_argument(
            ...
            type=int,
            help=_(
                "The maximum number of connections permitted for this "
        ...
        admin_group.add_argument(
            "--disable", action="store_true", default=None, help=_("Disable listener.")
        )
        return parser
...
class SetListener(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "listener", metavar="<listener>", help=_("Listener to modify (ID).")
        )
        parser.add_argument(
            "--name", metavar="<name>", help=_("Set the listener name.")
        )
...
class DeleteListener(command.Command):
    ...
    def take_action(self, parsed_args):
        ...
        for lsnr in parsed_args.listener:
            ...
            client.delete_listener(listener=obj.id, ignore_missing=False)
