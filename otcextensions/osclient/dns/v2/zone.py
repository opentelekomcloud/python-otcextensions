...
class ShowZone(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            default="public",
            help=_(
                "Mandatory for private Zone findings.\n"
    ...
    def take_action(self, parsed_args):
        ...
        obj = client.find_zone(parsed_args.zone, ignore_missing=False, **query)
...
class DeleteZone(command.Command):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            "zone", metavar="<zone>", nargs="+", help=_("UUID or name of the zone.")
        )
...
class CreateZone(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument("name", metavar="<name>", help=_("DNS Name for the zone."))
        parser.add_argument(
            "--email",
            metavar="<email>",
...
class SetZone(command.ShowOne):
    ...
    def take_action(self, parsed_args):
        ...
        if zone:
            obj = client.update_zone(zone=zone, **attrs)
...
class AssociateRouterToZone(command.ShowOne):
    ...
    def take_action(self, parsed_args):
        ...
        if zone:
            obj = client.add_router_to_zone(zone=zone, **router)
...
class DisassociateRouterToZone(command.ShowOne):
    ...
    def take_action(self, parsed_args):
        ...
        if zone:
            obj = client.remove_router_from_zone(zone=zone, **router)
