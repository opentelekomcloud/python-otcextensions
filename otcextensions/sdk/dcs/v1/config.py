...
class Config(resource.Resource):
    ...
    def _construct_dict_for_update(self, obj):
        return {key: obj[key] for key in ["param_id", "param_value", "param_name"]}

    def _update(self, session, params):
        """Update parameters of the instance"""
        filter_params = [self._construct_dict_for_update(obj) for obj in params]
        body = {"redis_config": filter_params}
