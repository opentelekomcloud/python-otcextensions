...
class ProtectionGroup(resource.Resource):
    ...
    _query_mapping = resource.QueryParameters(
        "availability_zone", "limit", "name", "offset", "query_type", "status"
    )
    ...
    disaster_recovery_drill_num = resource.Body("disaster_recovery_drill_num", type=int)
    ...
    def perform_failover(self, session, protection_group):
        ...
        """
        url = utils.urljoin(self.base_path, protection_group, "/action")
        body = {"failover-server-group": {}}
        return session.post(url, json=body)

    def perform_planned_failover(self, session, protection_group, priority_station):
        ...
        """
        url = utils.urljoin(self.base_path, protection_group, "/action")
        body = {"reverse-server-group": {"priority_station": priority_station}}
        return session.post(url, json=body)
