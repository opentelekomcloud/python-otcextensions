...
class Proxy(proxy.Proxy):
    ...
    def models(self, **params):
        ...
        :returns: a generator of
            :class:`~otcextensions.sdk.modelarts.v1.models.Model` instances
        """
    ...
    def create_model(self, **attrs):
        ...
        :param dict attrs: Keyword arguments which will be used to create
            a :class:`~otcextensions.sdk.modelarts.v1.models.Model`,
            comprised of the properties on the Model class.
        :returns: The results of model creation
        :rtype: :class:`~otcextensions.modelarts.v1.model.Model`
        """
        return self._create(
    ...
    def get_model(self, model):
        ...
        :param model: key id or an instance of
            :class:`~otcextensions.sdk.modelarts.v1.model.Model`
