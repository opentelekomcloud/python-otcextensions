...
class App(resource.Resource):
    ...
    _query_mapping = resource.QueryParameters("limit", "start_app_name", "stream_name")

    # Properties
    #: Unique identifier of the app.
    app_id = resource.Body("app_id", alternate_id=True)
    #: List of associated streams.
    commit_checkpoint_stream_names = resource.Body(
        "commit_checkpoint_stream_names", type=list
    )
