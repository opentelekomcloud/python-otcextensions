...
class Instance(resource.Resource):
    ...
    _query_mapping = resource.QueryParameters(
        "id", "name", "mode", "datastore_type", "vpc_id", "subnet_id", "limit", "offset"
    )
    ...
    def restart(self, session):
        """Restart Instance"""
        body = {"target_type": self.datastore_type, "target_id": self.id}
    ...
    def add_nodes(self, session, node_type, spec_code, num, volume=None):
        ...
        body = {"type": node_type, "spec_code": spec_code, "num": num}
    ...
    def resize(self, session, target_id, spec_code, target_type=None):
        body = {"resize": {"target_id": target_id, "target_spec_code": spec_code}}
    ...
    def change_private_ip(self, session, node_id, new_ip):
        body = {"node_id": node_id, "new_ip": new_ip}
    ...
    def create_ip(self, session, dds_type, password):
        body = {"type": dds_type, "password": password}
    ...
    def configure_client_network(self, session, network_ranges):
        body = {"client_network_ranges": network_ranges}
