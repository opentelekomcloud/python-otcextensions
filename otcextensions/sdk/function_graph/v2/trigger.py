...
class Trigger(resource.Resource):
    ...
    # SMN
    # KAFKA
    trigger_type_code = resource.Body("trigger_type_code", type=str, alternate_id=True)
    ...
    def _delete_trigger(self, session, function_urn, trigger_type_code, trigger_id):
        """Delete Trigger"""
        urn = function_urn.rpartition(":")[0]
        url = (
            self.base_path % {"function_urn": urn}
