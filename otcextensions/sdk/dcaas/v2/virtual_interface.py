...
class VirtualInterface(resource.Resource):
    base_path = '/virtual-interfaces'

    resources_key = 'virtual-interface'

    # capabilities
    allow_list = True

    _query_mapping = resource.QueryParameters(
        'project_id', 'name', 'description', 'direct_conect_id', 'vgw_id', 'type',
        'service_type', 'vlan', 'bandwidth', 'local_gateway_v4_ip',
        'remote_gateway_v4_ip', 'route_mode', 'bgp_asn', 'bgp_md5', 'remote_ep_group_id',
        'service_ep_group_id', 'admin_state_up', 'delete_time', 'rate_limit', project_id='tenant_id')
