...
class VirtualInterface(resource.Resource):
    ...
    _query_mapping = resource.QueryParameters(
        ...
        'admin_state_up', 'create_time', 'delete_time', 'status', 'rate_limit',
    ...
    #: Specifies the virtual interface type. The value can be public
    # or private.
    type = resource.Body('type')
    #: Specifies the access service type. The value can be vpc, public service,
    # or vpc and public service.
    service_type = resource.Body('service_type')
    #: Specifies the VLAN used by the local gateway to communicate with
    # the remote gateway.
    ...
    #: Specifies the ID of the remote endpoint group that records the tenant
    # CIDR blocks.
    remote_ep_group_id = resource.Body('remote_ep_group_id')
    #: Specifies the ID of the service endpoint group that records the public
    # service CIDR blocks.
    ...
    #: Specifies whether to limit the traffic rate. The value can be true
    # or false.
    rate_limit = resource.Body('rate_limit', type=bool)
    #: Specifies the virtual interface status. The value can be ACTIVE, DOWN,
