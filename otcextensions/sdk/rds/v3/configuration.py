...
class Configuration(_base.Resource):
    ...
    #: *Type:dict*
    configuration_parameters = resource.Body("configuration_parameters", type=list)
    #: Date of created
    #: *Type:str*
    ...
    def find(cls, session, name_or_id, ignore_missing=True, **params):
        instance = super(Configuration, cls).find(
            session, name_or_id, ignore_missing=ignore_missing, **params
        )
        if instance:
    ...
    def create(self, session, prepend_key=False, base_path=None):
        return super(Configuration, self).create(
