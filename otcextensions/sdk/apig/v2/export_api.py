...
class ExportApi(resource.Resource):
    base_path = "apigw/instances/%(gateway_id)s/openapi/export"
    ...
    def _export_api(self, session, gateway_id, full_path, **attrs):
...
class ImportApi(resource.Resource):
    base_path = "apigw/instances/%(gateway_id)s/openapi/import"
