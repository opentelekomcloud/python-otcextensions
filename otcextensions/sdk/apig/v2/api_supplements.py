...
class PublishApi(resource.Resource):
    base_path = "/apigw/instances/%(gateway_id)s/apis/action"
...
class CheckApi(resource.Resource):
    base_path = "/apigw/instances/%(gateway_id)s/apis/check"
...
class DebugApi(resource.Resource):
    base_path = "/apigw/instances/%(gateway_id)s/apis/debug/%(api_id)s"
...
class PublishApis(resource.Resource):
    base_path = "/apigw/instances/%(gateway_id)s/apis/publish"
    ...
    _query_mapping = resource.QueryParameters("limit", "offset", "env_id", "env_name")
...
class RuntimeDefinitionApi(resource.Resource):
    base_path = "/apigw/instances/%(gateway_id)s/apis/runtime/%(api_id)s"
...
class VersionsApi(resource.Resource):
    base_path = "/apigw/instances/%(gateway_id)s/apis/versions/%(version_id)s"
    ...
    # Backend parameters.
    backend_params = resource.Body("backend_params", type=list, list_type=BackendParam)
    ...
    policy_mocks = resource.Body("policy_mocks", type=list, list_type=ApiPolicyMock)
    # Web backend policies.
    policy_https = resource.Body("policy_https", type=list, list_type=ApiPolicyHttp)
