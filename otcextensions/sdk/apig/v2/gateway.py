...
class Gateway(resource.Resource):
    ...
    _query_mapping = resource.QueryParameters(
        "limit", "offset", "instance_id", "instance_name", "status"
    )
    ...
    cbc_operation_locks = resource.Body(
        "cbc_operation_locks", type=list, list_type=CbcOperationLockSpec
    )
    ...
    endpoint_services = resource.Body(
        "endpoint_services", type=list, list_type=EndPointServiceSpec
    )
