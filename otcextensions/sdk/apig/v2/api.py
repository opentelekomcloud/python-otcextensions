...
class ApiPolicyMock(resource.Resource):
    ...
    # Policy conditions.
    conditions = resource.Body("conditions", type=list, list_type=ApiCondition)
...
class ApiGroupCommonInfo(resource.Resource):
    ...
    sl_domain_access_enabled = resource.Body("sl_domain_access_enabled", type=bool)


class Api(resource.Resource):
    base_path = "/apigw/instances/%(gateway_id)s/apis"
