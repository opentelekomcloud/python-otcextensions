...
class SignatureBind(resource.Resource):
    base_path = "/apigw/instances/%(gateway_id)s/sign-bindings"
    ...
    _query_mapping = resource.QueryParameters(
        "limit", "offset", "api_id", "sign_id", "sign_name", "env_id"
    )
        ...
        **params,
        ...
        if has_body and response.status_code == 201:
            if hasattr(self, "bindings"):
                body = response.json()
                bindings = [SignatureBind.existing(**data) for data in body["bindings"]]
...
class NotBoundApi(resource.Resource):
    base_path = "/apigw/instances/%(gateway_id)s/sign-bindings/unbinded-apis"
    ...
    _query_mapping = resource.QueryParameters(
        "limit", "offset", "sign_id", "env_id", "api_id", "api_name", "group_id"
    )
...
class BoundApi(resource.Resource):
    base_path = "/apigw/instances/%(gateway_id)s/sign-bindings/binded-apis"
