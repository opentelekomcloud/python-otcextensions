...
class ErrorResponse(resource.Resource):
    ...
    headers = resource.Body("headers", type=list, list_type=ResponseInfoHeaderSpec)
    ...
    authorizer_identities_failure = resource.Body("AUTHORIZER_IDENTITIES_FAILURE")
    ...
    third_auth_identities_failure = resource.Body("THIRD_AUTH_IDENTITIES_FAILURE")
    third_auth_conf_failure = resource.Body("THIRD_AUTH_CONF_FAILURE")
    orchestration_parameter_not_found = resource.Body(
    ...
    def _get(
        ...
        url = (
            f"/apigw/instances/{gateway_id}/api-groups/{group_id}/"
    ...
    def _update(
        self, session, gateway_id, group_id, response_id, response_type, **attrs
    ):
        url = (
            f"/apigw/instances/{gateway_id}/api-groups/{group_id}/"
            f"gateway-responses/{response_id}/{response_type}"
