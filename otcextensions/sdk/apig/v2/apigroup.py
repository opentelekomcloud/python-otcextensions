...
class ApiGroup(resource.Resource):
    base_path = "/apigw/instances/%(gateway_id)s/api-groups"
    ...
    _query_mapping = resource.QueryParameters(
        "limit", "offset", "id", "name", "precise_search"
    )
    ...
    url_domains = resource.Body("url_domains", type=list, list_type=UrlDomainSpec)
