...
class Quota(resource.Resource):
    base_path = "/apigw/instances/%(gateway_id)s/apps/%(app_id)s/bound-quota"
...
class AccessControl(resource.Resource):
    base_path = "/apigw/instances/%(gateway_id)s/apps/%(app_url_id)s/app-acl"
    gateway_id = resource.URI("gateway_id")
...
class App(resource.Resource):
    base_path = "/apigw/instances/%(gateway_id)s/apps"
    resources_key = "apps"
